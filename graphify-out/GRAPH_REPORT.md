...
## Corpus Check
- 1510 files · ~2,190,843 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 54 file(s) not represented in the graph (top: (none) 16, .bat 5, .css 5)

## Summary
- 31827 nodes · 59129 edges · 1277 communities (1102 shown, 127 thin omitted)
...
## Communities (1277 total, 127 thin omitted)

### Community 0 - "backend/server.py"
Cohesion: 0.02
Nodes (234): admin_seed(), _agent_timeout_fallback_response(), AgentStatusEntry, AgentStatusResponse, AgentToolCallEntry, ApiKeyCreate, AuthorizeReposBody, _bootstrap_within_budget() (+226 more)

### Community 1 - "company_api.py"
Cohesion: 0.02
Nodes (192): ephemeral_ttl_hours(), Async read of the ephemeral TTL (hours) straight from the DB., account_lifecycle(), AccountLifecycleResponse, auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint() (+184 more)

### Community 2 - "TaskStatus"
Cohesion: 0.02
Nodes (168): _env_flag(), Read a boolean env var. Accepts 'true'/'1'/'yes' (case-insensitive)., Background dispatcher for task execution., Re-queue BLOCKED tasks that have cooled down and are ready for retry., Polls for queued task work and executes it through the coordinator. Crash…, Re-queue tasks stranded by a prior crash or hard-kill., TaskDispatcher, str (+160 more)

### Community 3 - "TaskSpec"
Cohesion: 0.03
Nodes (111): kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, AiderAdapter, TaskResult, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Run aider non-interactively via `--message` flag., Adapter for Aider — TIER 3 specialized git-aware code editor., json_safe() (+103 more)

### Community 4 - "test_llm_router_queue_cache.py"
Cohesion: 0.02
Nodes (128): Test hook — clear all usage accounting., reset(), CacheManager, cosine_similarity(), _Entry, LRUCache, payload_key(), Any (+120 more)

### Community 5 - "WebsiteScanner"
Cohesion: 0.02
Nodes (130): DetectedSystem, Evidence, OnboardingProgress, Result of a website scan with detected systems and stack inference., Evidence supporting a system detection., Tracks the onboarding progress for a company., A business system detected on a company's website or in their stack., Get the most confident evidence description. (+122 more)

### Community 6 - "TaskWorkflowService"
Cohesion: 0.02
Nodes (127): classify_domain(), agent/workflow.py — Persisted workflow state machine. Implements the Autonomous…, Return the best-matching domain for a task title+description., _apply_activity_status(), create_agent(), delete_agent(), get_agent(), _get_user() (+119 more)

### Community 7 - "proxy.py"
Cohesion: 0.03
Nodes (171): Describes a single worker's task and constraints., WorkerSpec, Attempt a named one-click fix., run_fix(), middleware, admin_control(), admin_create_key(), admin_create_user() (+163 more)

### Community 8 - "_fixture"
Cohesion: 0.02
Nodes (107): Set the global task store instance (e.g., during app startup with MongoDB)., set_task_store(), base_url(), mobile_page(), proxy_url(), Config, pytest_configure(), conftest.py — pytest fixtures and configuration for the E2E test suite.… (+99 more)
...
Cohesion: 0.02
Nodes (125): _brain_provider_status(), Return per-provider metadata for the GET endpoint. Iterates every provider in…, _active_primary_provider(), BrainConfig, BrainConfigPatch, BrainConfigStore, default_brain_config(), get_brain_config() (+117 more)
...
### Community 14 - "Task"
Cohesion: 0.03
Nodes (86): Full task/issue document., Update the updated_at timestamp., Task, _gate_outward_facing_enabled(), _is_brain_connection_error(), _is_outward_facing(), Any, BaseException (+78 more)

### Community 15 - "AgentJobManager"
Cohesion: 0.03
Nodes (65): AgentJob, AgentJobManager, heartbeat(), _now(), Any, Run a job using the provided runner and update the job's lifecycle, progress,…, Serialize the AgentJob to a JSON-serializable dictionary for external clients.…, Any (+57 more)
...
### Community 19 - "direct_chat.py"
Cohesion: 0.03
Nodes (94): DirectChatDoctor, PreflightIssue, PreflightReport, Any, BaseModel, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, Translate technical preflight issues into a conversational assistant reply., translate_error_to_conversational() (+86 more)
...
Cohesion: 0.02
Nodes (59): BusinessCategory, Find a website by its URL., Find a repository by its URL., A company website with detected systems and stack inference., A company repository with detected technologies and metadata., Extract the owner from the full name., Extract the repository name from the full name., Repo (+51 more)
...
Cohesion: 0.04
Nodes (86): _action_matches(), _as_list(), Decision, GroupPolicy, _host_matches(), Mode, _normalise_path(), _path_matches() (+78 more)

### Community 27 - "LLMRequest"
Cohesion: 0.04
Nodes (91): build_provider(), Normalise a configured ``kind`` to an adapter key., Instantiate the adapter for one provider config. Unknown kinds fall back to the…, resolve_kind(), LLMRequest, Cheap character-based token estimate (~4 chars/token). Deliberately dependency-…, A provider-neutral chat request. ``model`` is a *hint*: the router may…, _anthropic_provider() (+83 more)
...
### Community 29 - "get_task_store"
Cohesion: 0.03
Nodes (96): _autonomy_bg_cycle(), lifespan(), _deferred_startup_cleanup(), _migrate_brain_to_safe_default(), _maybe_boot_purge(), _purge_backlog_core(), quick_notes_submit(), _QuickNoteBody (+88 more)

### Community 30 - "TrafficDirector"
Cohesion: 0.04
...
Cohesion: 0.03
Nodes (79): Backoff policy for retryable failures., RetryConfig, BreakerState, Enum, str, packages/llm/health.py — provider health tracking and circuit breaking. Two…, Test hook — clear all health state., reset() (+71 more)

### Community 32 - "SQLiteStore"
Cohesion: 0.03
Nodes (59): Create a new company in SQLite., Update a company in SQLite., Delete a company and all associated data from SQLite., List companies from SQLite., Count total companies in SQLite., Reconstruct a Website from a SQLite row, preferring the full JSON blob (which…, Create a new website in SQLite. The full model is stored in ``data`` so scan…, Get a website by ID from SQLite. (+51 more)
...
### Community 34 - "RuntimeCapabilityRegistry"
Cohesion: 0.03
...
### Community 35 - "Initiative"
Cohesion: 0.03
Nodes (76): _bullets(), generate_backlog_retro(), generate_standup(), plan_next_sprint(), Agentic Agile — autonomous ceremonies (standup, retro, sprint planning). Where…, Render a :class:`Retrospective` as a markdown section., Derive a retrospective from the task tracker when no sprint is active. DONE /…, The result of allocating portfolio capacity into a new sprint. (+68 more)
...
### Community 37 - "test_trend_scoping.py"
Cohesion: 0.04
Nodes (85): Issue title: the failure mode plus how hard it is recurring., _company_attr(), company_stack_tags(), extract_stack_tags(), fan_out_trend(), fan_out_trends(), is_code_change_trend(), map_trend_to_company_task() (+77 more)

### Community 38 - "get"
Cohesion: 0.02
Nodes (92): auth_me(), auto_recommend_skills(), _check_storage_health(), cost_attribution_stats(), discover_remote_skills(), doctor_health(), _get_backend_sam(), get_brain_policy_route() (+84 more)
...
Cohesion: 0.04
Nodes (72): build_governance_router(), approve(), _decide(), deny(), destroy_sandbox(), get_audit(), get_budget(), get_metrics() (+64 more)
...
Cohesion: 0.04
Nodes (88): activation_required(), ActivationResult, activate_instance(), ActivateRequest, ActivateResponse, activation_audit_log(), activation_status(), ActivationStatusResponse (+80 more)

### Community 44 - "ExecutionRequest"
Cohesion: 0.04
Nodes (49): Called by APScheduler when a cron fires. Dispatches to the orchestrator. This…, #522 + #505: Reliability startup — schedule hydration, orchestrator restore,…, _scheduler_on_fire(), _startup_reliability_hooks(), get_orchestrator_supervisor(), OrchestratorSupervisor, Any, services/orchestrator_supervisor.py — Deterministic Supervisor Issue #522: A… (+41 more)

### Community 45 - "test_failover_client_shared.py"
Cohesion: 0.06
...
Cohesion: 0.04
Nodes (84): _decompose_into_subtasks(), _merge_changed_files(), Decompose a request into 2-3 sub-tasks for specialist fan-out. Default…, Collect changed_files across all specialists into a single de-duped list., ClassifyOutput, get_ceo_fallback_stats(), PlanOutput, CLASSIFY phase: domain and task type determination. (+76 more)

### Community 48 - "test_unit8_model_catalog.py"
Cohesion: 0.04
Nodes (74): get_catalog_models_route(), Return the mirrored model catalog (advisory-only). Flag-gated by…, Force a catalog mirror rebuild + persist (admin only). Rebuilds the catalog…, sync_catalog_route(), CatalogActiveBrain, CatalogMirror, CatalogProviderEntry, get_catalog() (+66 more)
...
### Community 50 - "LLMRouter"
Cohesion: 0.04
Nodes (66): Attempt, text_key(), summarise(), auto_disable(), _billing_signals(), describe(), disabled_provider_ids(), is_unfixable() (+58 more)

### Community 51 - "WorkflowEngine"
Cohesion: 0.05
Nodes (50): AgentRole, TestSlice, _extract_slices_from_plan(), Any, Connection, Path, PhaseType, WorkflowRun (+42 more)
...
Cohesion: 0.04
Nodes (54): Resolve the JWT signing secret, with a *stable* fallback. Bug fix: the previous…, _resolve_jwt_secret(), AuditEvent, AuditLog, events_from_identity(), _luhn_ok(), Any, packages/governance/audit.py — the evidence trail for every governed action.… (+46 more)
...
Cohesion: 0.04
Nodes (64): Record token usage for *model* (fire-and-forget, never raises). ``tag`` is a…, record_usage(), _acquire_provider_probe(), clear_cooldowns(), CommercialFallbackRequiredError, _dead_model_key(), _exponential_backoff_cooldown(), get_dead_models() (+56 more)

### Community 56 - "BrainWatchdog"
Cohesion: 0.04
Nodes (63): emit_agency_observation(), Record an agency platform operation in Langfuse. Unlike…, get_brain_config_store(), Return the process-wide ``BrainConfigStore`` singleton., Any, packages/ai/self_heal.py — automatic brain self-healing. When the active brain…, Background tick that runs self_heal_brain_and_unblock_tasks(). Called from the…, One-shot self-healing pass. 1. Checks if the active brain provider is in a… (+55 more)
...
### Community 62 - "test_agent_runner.py"
Cohesion: 0.04
...
### Community 68 - "UserRole"
Cohesion: 0.06
Nodes (57): UserRole, _can_read(), _can_write(), create_secret(), _decrypt(), delete_secret(), _encrypt(), _get_master_key() (+49 more)

### Community 69 - "RenderMCPClient"
Cohesion: 0.04
...
### Community 70 - "get_runtime_manager"
Cohesion: 0.05
...
### Community 74 - "WorkspaceTools"
Cohesion: 0.04
Nodes (48): Path, tools.py — WorkspaceTools: read/write/search and diff application (risky…, Precise string replacement — F1 roadmap item (Codebuff/Claude Code-style edit).…, Return the first *lines* lines of a file. Just-in-time retrieval: the executor…, Return a lightweight index of files with line counts and sizes. This is the…, Delegate to RepowiseIntelligence for a natural-language codebase question., Delegate to RepowiseIntelligence for a semantic/text codebase search., Delegate to RepowiseIntelligence to list architectural decision nodes. (+40 more)

### Community 75 - "test_web_reach.py"
Cohesion: 0.05
Nodes (50): _egress_policy_reason(), _load_script_module(), Any, ModuleType, agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Return why governance policy blocks *host*, or None. Runs strictly *after* the…, Dynamically load a pure-stdlib helper module from .github/scripts/. Returns…, Zero-key internet access: pages, YouTube transcripts, search, RSS. Every public… (+42 more)

### Community 76 - "ProviderConfig"
Cohesion: 0.05
Nodes (68): _apply_env_overrides(), _apply_key_env(), _build(), _coerce(), config_dir(), _env_key_names(), expand_env(), _fields_of() (+60 more)

### Community 77 - "PrimeAgentAdapter"
Cohesion: 0.05
...
Cohesion: 0.04
Nodes (51): extract_openai_text(), _normalize_nvidia_base_url(), _openai_url(), Normalize NVIDIA base URLs to avoid double /v1 when openai_compat_url appends…, _nvidia_provider_chain(), ProviderConfig, Build Nvidia NIM provider config from env. Empty list when key is absent., Registry base URLs must produce routes the provider actually serves. (+43 more)
...
### Community 82 - "test_user_research_skill.py"
Cohesion: 0.05
Nodes (40): analyze_quantitative(), _classify_sentiment(), _extract_keywords(), plan_research(), Any, BaseModel, field_validator, QualQuote (+32 more)
...
### Community 88 - "test_slop_gate.py"
Cohesion: 0.05
...
### Community 89 - "models/seo_audit.py"
Cohesion: 0.07
Nodes (32): BaseModel, models/seo_audit.py - SEO / GEO / AIO Audit Contracts Typed Pydantic models for…, Snapshot of one crawled page with the on-page facts the checks used., Lightweight listing entry for past audits., Request to remediate auto-fixable findings in a local code repository., One concrete remediation performed (or proposed) by the fixer., Result of a fixer run., SeoAuditSummary (+24 more)

### Community 90 - "CEODispatcher"
Cohesion: 0.05
Nodes (50): CEODispatcher, _runner_factory(), CEOResult, _complexity_rank(), _offload(), Any, Semaphore, Run a synchronous ledger call without blocking the event loop. ``CEOLedger`` is… (+42 more)

### Community 91 - "test_cost_aware_routing_eval.py"
Cohesion: 0.06
...
### Community 93 - "resolve_active_brain"
Cohesion: 0.05
Nodes (63): livenim, BrainResolution, get_active_brain_sync(), get_provider_role_tags(), _host_is_openai_compatible(), _norm(), _pick_from_records(), _build() (+55 more)
...
### Community 95 - "TestSelfHealingInfrastructureClassification"
Cohesion: 0.05
...
### Community 96 - "register_webui"
Cohesion: 0.05
Nodes (56): allow_paid_brain(), get_brain_preference(), True only when the operator explicitly opted into a paid (Anthropic) brain.…, Return the operator's brain provider preference. Values: - ``"nvidia"`` —…, Any, Path, run_command(), _safe_allowlist() (+48 more)

### Community 97 - "WorkflowRun"
Cohesion: 0.05
Nodes (40): _fake_artifact(), _make_engine(), tests/test_crispy_workflow.py — CRISPY workflow engine hardening tests. Tests…, Provide isolated DB + artifact + workspace paths., Create a WorkflowEngine with isolated storage., TestAbortOnFailure, _test(), _tracking_run_single() (+32 more)
...
### Community 101 - "test_repo_connection.py"
Cohesion: 0.06
...
Cohesion: 0.04
Nodes (42): _describe_http_status(), _is_dns_failure(), _probe_failure_reason(), probe_model_liveness(), _probe_ollama(), _probe_openai_compat(), BaseException, services/brain_liveness.py — Provider liveness prober for the brain switcher.… (+34 more)

### Community 103 - "sync/service.py"
Cohesion: 0.06
...
### Community 108 - "resolve_e2b_config"
Cohesion: 0.05
...
### Community 113 - "test_model_catalog.py"
Cohesion: 0.05
...
### Community 115 - "FinancialMetrics"
Cohesion: 0.06
...
### Community 118 - "test_runtime_governance.py"
Cohesion: 0.08
Nodes (53): _blocked_result(), _governance_check(), TaskResult, Build the failed TaskResult returned when policy denies a dispatch. A result…, Evaluate a runtime dispatch against policy; audit it either way. Returns…, Full record of a routing decision — audit-trail entry., Selects a runtime for the given task, executes the task (including readiness…, Execute the given task spec on the primary runtime, attempt configured fallback… (+45 more)
...
### Community 120 - "loop.py"
Cohesion: 0.05
Nodes (53): get_enrichment(), agent/harness_enrichment.py — Automatic Harness Enrichment for Agent Prompts…, Return the enrichment instance for a workspace. Keyed by workspace root rather…, _check_extra_kwargs(), _enforce_signature(), _note_phase_end(), _note_phase_start(), loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures. (+45 more)
...
### Community 122 - "ProviderRouter"
Cohesion: 0.06
Nodes (29): build_tool_calling_router(), Return a router limited to providers that pass ``tools`` through intact. The…, _normalized_provider_type(), _ollama_reasoning_effort(), ProviderRouter, Any, Parse a 429/503 ``Retry-After`` header → seconds, or None. Accepts either…, Translate an OpenAI chat/completions payload to Bedrock Converse format. (+21 more)

### Community 123 - "ProviderConfig"
Cohesion: 0.05
Nodes (47): is_commercial_provider(), provider_access_tier(), _provider_field(), provider_sort_key(), ProviderConfig, Infer an access tier from *hostname*, longest matching suffix winning. Returns…, _tier_from_hostname(), local_brain_enabled() (+39 more)
...
### Community 127 - "test_procedural_memory.py"
Cohesion: 0.05
...
### Community 130 - "skill_bindings.py"
Cohesion: 0.05
...
### Community 138 - "StreamingDeltaReconstructor"
Cohesion: 0.05
...
### Community 139 - "test_sqlite_store.py"
Cohesion: 0.06
...
### Community 142 - "PatternConsolidation"
Cohesion: 0.06
...
### Community 144 - "persist_plan_spec"
Cohesion: 0.06
...
### Community 146 - "test_schedule_growth_invariants.py"
Cohesion: 0.04
...
Cohesion: 0.05
Nodes (37): _run(), _latest_metric_value(), _note_recurrence(), _parse_timestamp(), Any, datetime, services/render_ops.py — autonomous Render debugging + environment monitoring.…, Parse an RFC3339 timestamp from Render, tolerating a trailing ``Z``. (+29 more)
...
### Community 159 - "test_kimi_bridge_server.py"
Cohesion: 0.05
...
### Community 160 - "test_bedrock_provider.py"
Cohesion: 0.06
...
### Community 165 - "ChatHistoryStore"
Cohesion: 0.07
...
Cohesion: 0.07
Nodes (49): _actor(), build_platform_controls_router(), _admin(), list_controls(), reset_control(), update_controls(), ControlUpdateBody, APIRouter (+41 more)
...
### Community 171 - "test_startup_warmup.py"
Cohesion: 0.05
Nodes (40): _isolate_warmup_overflow(), asyncio, NoReturn, RuntimeError, Regression tests for the bounded startup warm-up and login bootstrap. Uvicorn…, A deferred step that fails must not leak a reference or an exception., Wire only what is missing — never replace a store somebody registered.…, The deferred-bootstrap path: nothing registered, so wire it now. (+32 more)
...
### Community 174 - "failover_client.py"
Cohesion: 0.06
...
### Community 175 - "E2BAdapter"
Cohesion: 0.07
Nodes (36): E2BAdapter, Any, Runtime adapter that executes tasks inside an E2B sandbox. Activation:…, _FakeAsyncSandboxClass, _FakeCommandResult, _FakeCommands, _FakeFiles, _FakeSandbox (+28 more)
...
### Community 182 - "_resolve_brain_provider"
Cohesion: 0.06
...
### Community 194 - "test_failover_silent_exhaustion.py"
Cohesion: 0.06
...
### Community 207 - "workflow_orchestrator.py"
Cohesion: 0.09
...
Cohesion: 0.09
Nodes (37): _apply_chat_defaults(), _emit_safely(), _extract_exact_output(), _filter_fragment(), _filter_openai_sse_line(), handle_ollama_native_chat(), handle_openai_chat_completions(), _single_exact_stream() (+29 more)

### Community 210 - "FeatureMaturity"
Cohesion: 0.06
Nodes (27): __init__.py — Feature flag/matrix package., FeatureMaturity, FeatureUnavailableError, Enum, Exception, str, features/matrix.py — Feature maturity tiers and support matrix. Single source…, Feature maturity classification. (+19 more)

### Community 211 - "all_provider_ids"
Cohesion: 0.05
...
### Community 216 - "portfolio_api.py"
Cohesion: 0.08
...
### Community 220 - "nvidia_models.py"
Cohesion: 0.07
...
### Community 231 - "LlmProviderConfig"
Cohesion: 0.12
...
### Community 232 - "_resolve_user_github_token"
Cohesion: 0.08
...
### Community 245 - "test_purge_backlog.py"
Cohesion: 0.07
...
### Community 247 - "ensure_self_company"
Cohesion: 0.07
Nodes (26): autonomy_status(), Public autonomy readiness probe — no authentication required. A live deploy…, Fire-and-forget self-bootstrap; never blocks or crashes startup., _schedule_self_bootstrap(), ensure_self_company(), _find_self_company(), _find_stale_self_companies(), _list_companies_safe() (+18 more)
...
### Community 256 - "get_feature_matrix"
Cohesion: 0.08
...
### Community 257 - "system_instruction"
Cohesion: 0.09
...
### Community 258 - "test_mcp_governance.py"
Cohesion: 0.09
...
### Community 267 - "test_backend_server_features.py"
Cohesion: 0.07
...
### Community 268 - "model_discovery.py"
Cohesion: 0.07
...
### Community 275 - "test_implement_agent_routing.py"
Cohesion: 0.07
...
### Community 280 - "configuration-reference.md"
Cohesion: 0.08
...
### Community 283 - "test_brain_failover.py"
Cohesion: 0.11
...
### Community 286 - "test_colibri_brain_shim.py"
Cohesion: 0.07
...
### Community 287 - "test_nvidia_model_discovery.py"
Cohesion: 0.06
...
Cohesion: 0.09
Nodes (26): get_skill(), list_skills(), List all available skills with optional filtering. Returns the skill catalog…, Get a single skill by its ID., build_matrix(), _families(), main(), Any (+18 more)
...
### Community 295 - "test_live_server.py"
Cohesion: 0.22
...
### Community 296 - "test_render_mcp.py"
Cohesion: 0.10
...
### Community 297 - "ContextCompressor"
Cohesion: 0.11
...
### Community 300 - "ResourceWatchdog"
Cohesion: 0.10
...
### Community 301 - "test_daily_2026_06_04.py"
Cohesion: 0.10
...
### Community 303 - "test_chat_mode_regressions.py"
Cohesion: 0.10
...
### Community 310 - "BrainFailoverManager"
Cohesion: 0.09
...
### Community 311 - "test_telegram_mutating_commands.py"
Cohesion: 0.09
...
### Community 315 - "High-Agency Frontend Skill"
Cohesion: 0.06
Nodes (30): 10. FINAL PRE-FLIGHT CHECK, 1. ACTIVE BASELINE CONFIGURATION, 2. DEFAULT ARCHITECTURE & CONVENTIONS, 3. DESIGN ENGINEERING DIRECTIVES (Bias Correction), 4. CREATIVE PROACTIVITY (Anti-Slop Implementation), 5. PERFORMANCE GUARDRAILS, 6. TECHNICAL REFERENCE (Dial Definitions), 7. AI TELLS (Forbidden Patterns) (+22 more)

### Community 316 - "facade.py"
Cohesion: 0.09
...
### Community 317 - "Quick-Note GitHub Issues Processing - Session Summary"
Cohesion: 0.06
...
### Community 318 - "test_connector_registry.py"
Cohesion: 0.08
...
### Community 321 - "session_retro.py"
Cohesion: 0.13
...
### Community 322 - "test_agency_fix.py"
Cohesion: 0.06
...
### Community 325 - "test_phase6_workflow.py"
Cohesion: 0.12
...
### Community 330 - "test_colibri_provider.py"
Cohesion: 0.12
...
### Community 332 - "brain_failover.py"
Cohesion: 0.11
...
### Community 334 - "OrchestratorCheckpointStore"
Cohesion: 0.10
...
### Community 335 - "_redact_for_notification"
Cohesion: 0.11
...
### Community 337 - "test_force_cleanup_conditional_delete.py"
Cohesion: 0.10
...
### Community 338 - "_register_builtin_tools"
Cohesion: 0.08
...
### Community 340 - "test_rag_context.py"
Cohesion: 0.12
...
### Community 341 - "ProjectScaffolder"
Cohesion: 0.13
...
### Community 343 - "test_dashboard_cache.py"
Cohesion: 0.10
...
### Community 347 - "RuntimeHealthService"
Cohesion: 0.10
...
### Community 350 - "test_provider_state_durability.py"
Cohesion: 0.09
Nodes (17): True when operator state is stored somewhere that survives a redeploy. False…, Drop the cached Mongo client, backoff, and read caches (tests)., reset_kv_state(), state_is_durable(), fake_mongo(), _FakeCollection, _FakeDb, isolated_state() (+9 more)

### Community 351 - "isolated_telegram_config"
Cohesion: 0.10
...
### Community 352 - "test_internal_agent_did_work.py"
Cohesion: 0.12
...
### Community 353 - "_captured_request_headers"
Cohesion: 0.12
...
### Community 355 - "PolicyDecision"
Cohesion: 0.11
Nodes (18): _do_run_agent_job(), _run_agent_job(), wait_for_resume(), guard_tool_call(), GuardResult, Any, The outcome of guarding one action., A message safe to hand back to the model as a tool result. Names the rule so… (+10 more)
...
### Community 358 - "ProviderConsole.jsx"
Cohesion: 0.08
...
### Community 361 - "webui/frontend/package.json"
Cohesion: 0.07
...
### Community 367 - "test_harness_spec.py"
Cohesion: 0.16
...
### Community 371 - "build_render_router"
Cohesion: 0.14
...
### Community 373 - "Deploy: FreeBuff Telegram bot (24×7)"
Cohesion: 0.07
...
### Community 374 - "Claude Code + Qwen Local Setup"
Cohesion: 0.07
...
### Community 375 - "CompanyAgencyService"
Cohesion: 0.09
...
### Community 376 - "TestNoNvidiaFallbackIsRetired"
Cohesion: 0.09
...
### Community 383 - "test_agent_chat_integration.py"
Cohesion: 0.13
...
### Community 386 - "telegram_inbound_handlers.py"
Cohesion: 0.13
...
### Community 393 - "TestStreamableHTTPTransport"
Cohesion: 0.12
...
### Community 398 - "video_transcript.py"
Cohesion: 0.11
...
### Community 403 - "TemporalContextGraph"
Cohesion: 0.10
...
### Community 404 - "test_telegram_approval_e2e.py"
Cohesion: 0.12
...
### Community 405 - "test_activation_api.py"
Cohesion: 0.13
...
### Community 406 - "test_backend_runtime_bootstrap.py"
Cohesion: 0.09
...
### Community 408 - "test_service_token.py"
Cohesion: 0.08
...
### Community 409 - "test_telegram_diag_endpoint.py"
Cohesion: 0.08
...
### Community 413 - "Traffic Distribution Across Providers"
Cohesion: 0.08
...
### Community 414 - "Implementation Prompt: Rich TaskBoard + Agile Sprint Integration"
Cohesion: 0.08
...
### Community 415 - "Telegram Bot Setup"
Cohesion: 0.08
...
### Community 420 - "test_all_features.py"
Cohesion: 0.08
...
### Community 423 - "register_admin_gui"
Cohesion: 0.18
...
### Community 425 - "SeoCheckDefinition"
Cohesion: 0.11
...
### Community 431 - "implement_agent.py"
Cohesion: 0.12
...
### Community 433 - "test_north_mini_code.py"
Cohesion: 0.09
...
### Community 434 - "TestModelRegistryUpdates"
Cohesion: 0.14
...
### Community 436 - "test_memory_guard.py"
Cohesion: 0.13
...
### Community 439 - "test_agent_free_brain.py"
Cohesion: 0.09
...
### Community 454 - "PriorityTaskQueue"
Cohesion: 0.14
...
### Community 455 - "TestLegacyRouterCacheTTL"
Cohesion: 0.13
...
### Community 456 - "test_anthropic_refusal_fallback.py"
Cohesion: 0.19
...
### Community 461 - "V3 API Migration Plan — LLM Relay Platform"
Cohesion: 0.10
...
### Community 464 - "ClaudeCodeAdapter"
Cohesion: 0.19
...
### Community 466 - "_process_task_callback"
Cohesion: 0.20
...
### Community 467 - ".on_task_complete"
Cohesion: 0.11
...
### Community 468 - "TestAddConversationCacheBreakpoints"
Cohesion: 0.15
...
### Community 469 - "test_local_controller.py"
Cohesion: 0.14
...
### Community 470 - "test_openclaw_str_e_fix.py"
Cohesion: 0.10
...
### Community 490 - "get_ceo_dispatcher"
Cohesion: 0.13
...
### Community 492 - "test_agent_api.py"
Cohesion: 0.14
...
### Community 497 - "get_tool_registry"
Cohesion: 0.13
...
### Community 507 - "TestNormalizeResponseFormat"
Cohesion: 0.11
...
### Community 521 - "test_autonomy_status.py"
Cohesion: 0.11
...
### Community 522 - "test_brain_patch_service_token.py"
Cohesion: 0.18
...
### Community 523 - "TestMCPToolsListCache"
Cohesion: 0.15
...
### Community 524 - "test_fabric_patterns.py"
Cohesion: 0.11
...
### Community 525 - "test_freebuff_bot.py"
Cohesion: 0.11
...
### Community 531 - ".update_intelligence"
Cohesion: 0.11
...
### Community 534 - "agile_sprints.py"
Cohesion: 0.14
...
### Community 544 - "router/health.py"
Cohesion: 0.16
...
### Community 550 - "test_company_api.py"
Cohesion: 0.11
...
### Community 551 - "test_daily_automation_2026_07_11.py"
Cohesion: 0.14
...
### Community 552 - "test_langfuse_agency_wide.py"
Cohesion: 0.11
...
### Community 553 - "test_monitor_lib.py"
Cohesion: 0.15
...
### Community 556 - "test_schedule_persistence.py"
Cohesion: 0.16
...
### Community 557 - "test_contract_enforcement.py"
Cohesion: 0.17
...
### Community 580 - "test_task_brain_preflight.py"
Cohesion: 0.21
...
### Community 584 - "analyze_qualitative"
Cohesion: 0.22
...
### Community 596 - "RateLimitTracker"
Cohesion: 0.16
...
### Community 604 - "TestAnthropicToolListCaching"
Cohesion: 0.28
...
### Community 605 - "test_brain_failover_413.py"
Cohesion: 0.13
...
### Community 628 - "verify_service_token"
Cohesion: 0.19
...
### Community 629 - "Skill: user-research"
Cohesion: 0.13
...
### Community 633 - "test_rate_limiter.py"
Cohesion: 0.20
...
### Community 641 - "test_daemon_restart_reprobes_http_port_only"
Cohesion: 0.13
...
### Community 642 - "test_failover_raises_503_when_all_fail"
Cohesion: 0.16
...
### Community 643 - "test_scanner_live.py"
Cohesion: 0.23
...
### Community 657 - "admin_digest_router.py"
Cohesion: 0.22
...
### Community 663 - "DirectChatSession"
Cohesion: 0.15
...
### Community 676 - "test_setup_api.py"
Cohesion: 0.21
...
### Community 677 - "test_wrapper_falls_back_to_installed_model"
Cohesion: 0.19
...
### Community 678 - "test_changelog_check_workflow.py"
Cohesion: 0.21
...
### Community 679 - "TestMCPClientStructuredOutput"
Cohesion: 0.27
...
### Community 680 - "_StubManager"
Cohesion: 0.14
Nodes (3): _apply(), Minimal stand-in for BrainFailoverManager., _StubManager

### Community 681 - ".test_set_github_token_sqlite_string_id_does_not_500"
Cohesion: 0.16
...
### Community 712 - "_is_bedrock_model_id"
Cohesion: 0.27
...
### Community 717 - "scan_repo_with_user_research.py"
Cohesion: 0.22
...
### Community 722 - "TestModelCostTableUpdates"
Cohesion: 0.26
...
### Community 738 - "build_admin_local_brain_router"
Cohesion: 0.24
...
### Community 740 - "connectors_api.py"
Cohesion: 0.21
...
### Community 754 - "install-agents.sh"
Cohesion: 0.39
...
### Community 755 - "check_container_posture.py"
Cohesion: 0.26
...
### Community 756 - "test_pytest_failure_parser.py"
Cohesion: 0.23
...
### Community 763 - "TestDisabledProvidersAreNotFalselyReportedUnreachable"
Cohesion: 0.18
...
### Community 764 - "test_gh_brain_failover.py"
Cohesion: 0.17
...
### Community 771 - "RepowiseIntelligence"
Cohesion: 0.33
...
### Community 788 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 789 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 790 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 791 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 792 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 794 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 795 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 796 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 797 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 798 - "What to clean up"
Cohesion: 0.18
...
### Community 799 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 807 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 808 - "test_event_log.py"
Cohesion: 0.45
...
### Community 809 - "TestZeroAttemptDiagnostics"
Cohesion: 0.25
...
### Community 816 - "_normalize_tool_choice"
Cohesion: 0.31
...
### Community 817 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 818 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 819 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 820 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 821 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 822 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 823 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 825 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 826 - "Competitor Analysis — Autonomous AI Agency"
Cohesion: 0.20
...
### Community 827 - "Issue #1427: quick-note:https://github.com/bingreeky/JIT"
Cohesion: 0.20
...
### Community 831 - "_parse_reset_epoch"
Cohesion: 0.33
...
### Community 832 - "capture_screens.py"
Cohesion: 0.29
...
### Community 833 - "TestModelsEndpointAliases"
Cohesion: 0.31
...
### Community 841 - "TestRevenuePortfolio"
Cohesion: 0.20
...
### Community 877 - ".test_every_request_carries_a_real_user_agent"
Cohesion: 0.22
...
### Community 879 - "test_daemon_picks_colibri_8081_when_only_it_listening"
Cohesion: 0.22
...
### Community 892 - "CapacityAllocation"
Cohesion: 0.25
...
### Community 895 - "_build_direct_chat_schedule_suggestion"
Cohesion: 0.32
...
### Community 896 - "_start_in_web_bot_tasks"
Cohesion: 0.29
...
### Community 906 - "AGENTS.md — AI Agent Configuration for local-llm-server"
Cohesion: 0.25
...
### Community 907 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 908 - "ceo-micromanagement.md"
Cohesion: 0.25
...
### Community 945 - "Prime Agent Runtime"
Cohesion: 0.25
...
### Community 946 - "PULL_REQUEST_TEMPLATE.md"
Cohesion: 0.25
...
### Community 954 - "_answer_callback"
Cohesion: 0.29
...
### Community 959 - "TestReviewRegressions"
Cohesion: 0.25
...
### Community 961 - "test_mcp_protocol_version.py"
Cohesion: 0.25
...
### Community 966 - "test_nuclear_cleanup_targets_the_schedule_collection"
Cohesion: 0.25
...
### Community 982 - "AI Engineering Insights Skill"
Cohesion: 0.29
...
### Community 983 - "Skill: hybrid-reasoning (Hybrid AI)"
Cohesion: 0.29
...
### Community 991 - "_AllSignatures"
Cohesion: 0.29
Nodes (5): dict, set, _AllSignatures, _AnyText, A mapping that accepts any entry text for any signature.

### Community 992 - "ADR-006: Strangler Fig migration with backward-compat shims"
Cohesion: 0.29
...
### Community 996 - "claude-mem Plugin — Persistent Memory for All Sessions"
Cohesion: 0.29
...
### Community 997 - "Implementation plan + TO-DO (check off as you go)"
Cohesion: 0.29
...
### Community 1000 - "Cloudflare = the real working app"
Cohesion: 0.29
...
### Community 1007 - "check_changelog_parity.py"
Cohesion: 0.43
...
### Community 1008 - "check_doc_images.py"
Cohesion: 0.48
...
### Community 1009 - "BackgroundServices"
Cohesion: 0.38
...
### Community 1013 - "TestPolicyAuthoringUiStableClaim"
Cohesion: 0.29
...
### Community 1014 - "test_log_monitor_storm_guard.py"
Cohesion: 0.48
...
### Community 1015 - "TestReasonsAreActionable"
Cohesion: 0.29
...
### Community 1016 - "TestProvidersScreen"
Cohesion: 0.43
...
### Community 1021 - "agent/output_filter.py"
Cohesion: 0.33
...
### Community 1022 - "._run_git_command"
Cohesion: 0.33
...
### Community 1023 - "._get_last_commit"
Cohesion: 0.33
...
### Community 1055 - "test_activity_feed.py"
Cohesion: 0.33
...
### Community 1057 - "TestAgentRunnerExecution"
Cohesion: 0.33
...
### Community 1058 - "TestWorkflowIntegration"
Cohesion: 0.33
...
### Community 1059 - "test_catalogue_probe.py"
Cohesion: 0.33
...
### Community 1064 - "test_runtime_registration_scope.py"
Cohesion: 0.33
...
### Community 1072 - "/arch-review — Architecture Agent"
Cohesion: 0.40
...
### Community 1082 - "Agent job lifecycle"
Cohesion: 0.40
...
### Community 1109 - "TestInternalAgentAdapterProviderChain"
Cohesion: 0.40
...
### Community 1114 - "test_activity_logs.py"
Cohesion: 0.67
...
### Community 1143 - "test_no_exception_detail_leaks.py"
Cohesion: 0.50
...
### Community 1144 - "test_skills_route_order.py"
Cohesion: 0.67
...
- **3526 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3521 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 14263 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **127 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `_fixture()` connect `_fixture` to `TaskStatus`, `test_llm_router_queue_cache.py`, `WebsiteScanner`, `TaskWorkflowService`, `test_autonomy_status.py`, `brain_config.py`, `test_brain_patch_service_token.py`, `llm/router.py`, `test_freebuff_bot.py`, `test_llm_router_strategies.py`, `test_operational_incidents.py`, `ImprovementLoop`, `Task`, `test_model_router.py`, `direct_chat.py`, `SelfHealingAgent`, `AgentRunner`, `PolicyEngine`, `E2BSandboxSession`, `TrafficDirector`, `test_llm_router_resilience.py`, `test_catalogue_probe.py`, `test_trend_scoping.py`, `test_company_api.py`, `test_monitor_lib.py`, `test_phase5_doctor.py`, `ExecutionRequest`, `test_failover_client_shared.py`, `test_unit8_model_catalog.py`, `services/background.py`, `LLMRouter`, `services/seo_audit.py`, `AuditLog`, `ai/router.py`, `BrainWatchdog`, `WorkflowRun`, `Agency`, `e2e/test_browser.py`, `test_openclaw_endpoints.py`, `test_task_brain_preflight.py`, `test_sam_livekit.py`, `AgentSwarm`, `ProviderConfig`, `PrimeAgentAdapter`, `Specialist`, `test_webui_provider_priority.py`, `test_provider_router.py`, `BackgroundAgent`, `TokenBudget`, `controls_app`, `SQLiteStore`, `models/seo_audit.py`, `ResearchTask`, `test_brain_failover_413.py`, `resolve_active_brain`, `TestSelfHealingInfrastructureClassification`, `WorkflowRun`, `test_local_brain_state.py`, `TestClient`, `TestChatHistoryStore`, `test_sam_voice.py`, `test_refresh_agent_built_proof.py`, `ArtifactStore`, `resolve_e2b_config`, `test_knowledge_sync.py`, `run_task`, `test_new_features_e2e.py`, `cost_tracker.py`, `ProviderConfig`, `test_procedural_memory.py`, `TestHarnessAdapter`, `test_issue_intake.py`, `persist_plan_spec`, `test_context_rulebook.py`, `ModelRouter`, `test_trend_watcher.py`, `test_llm_router_e2e.py`, `test_kimi_bridge_server.py`, `tests/conftest.py`, `ApprovalStore`, `ChatHistoryStore`, `_step`, `test_changelog_check_workflow.py`, `test_telegram_freebuff.py`, `test_openclaw_gateway.py`, `test_startup_warmup.py`, `TestEstimateTokensForMessages`, `E2BAdapter`, `claim`, `MCPClient`, `KeyStore`, `_resolve_brain_provider`, `test_e2b_data_flow.py`, `test_process_quick_note_workflow.py`, `NotificationDispatcher`, `test_platform_controls.py`, `OllamaCircuitBreaker`, `_Budget`, `_job_text`, `test_video_transcript.py`, `CEOLedger`, `SchedulerStore`, `test_agent_tool_governance.py`, `test_features_api.py`, `nvidia_models.py`, `WorkflowBuildRequest`, `_resolve_user_github_token`, `OrchestratorQueue`, `test_purge_backlog.py`, `TrendWatcher`, `test_agile_api.py`, `test_app_settings.py`, `TestClient`, `test_gh_brain_failover.py`, `test_task_clarification.py`, `test_telegram_webhook.py`, `get_feature_matrix`, `test_mcp_governance.py`, `test_control_plane_api.py`, `ContextPruner`, `api_keys_for`, `model_discovery.py`, `test_persistent_memory.py`, `test_provider_enable_disable.py`, `SecurityScanner`, `test_colibri_brain_shim.py`, `test_nvidia_model_discovery.py`, `OutputFilter`, `rate_limiter.py`, `get_skill_bindings`, `analyze_page`, `session_retro.py`, `test_agency_fix.py`, `test_skill_registry_boot_refresh.py`, `TestMongoGate`, `test_scheduler_hydration_bounded.py`, `test_ceo_router.py`, `OrchestratorCheckpointStore`, `_redact_for_notification`, `test_dashboard_cache.py`, `parse_event_stream`, `test_provider_state_durability.py`, `isolated_telegram_config`, `TestSwarmRoleRouting`, `test_regression.py`, `test_agent_scripts_share_one_model_list.py`, `test_crispy_burn_in.py`, `test_harness_spec.py`, `_Recorder`, `telegram_inbound_handlers.py`, `_undeclared`, `test_service_token.py`, `test_telegram_diag_endpoint.py`, `_client`, `test_agent_free_brain.py`, `TestTheWorkflowIsSafeAndReadOnly`, `test_v4_api.py`, `test_doctor_coding_brain.py`, `test_mcp_protocol_version.py`, `test_ping.py`, `test_runtimes_health_endpoint.py`, `test_task_store_fails_loud_in_production.py`, `captured`, `UsageEvent`, `ClaudeCodeAdapter`, `.on_task_complete`, `test_voice_pipeline.py`, `get_ceo_dispatcher`, `client`, `TestNormalizeResponseFormat`?**
  _High betweenness centrality (0.104) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `TaskSpec`, `AdaptiveHalter`, `ContextPruner`, `UserMemoryStore`, `proxy.py`, `FreeBuffAgent`, `test_backend_server_features.py`, `test_governance_api.py`, `direct_chat.py`, `test_ceo_micromanager.py`, `AgentSessionStore`, `PolicyEngine`, `E2BSandboxSession`, `MultiAgentSwarm`, `ReactScratchpad`, `Initiative`, `TestAgentRunnerExecution`, `test_daily_automation_2026_07_11.py`, `test_empirical_verify.py`, `ContextManager`, `test_failover_client_shared.py`, `E2BAdapter`, `MCPClient`, `test_agent_free_brain.py`, `StuckDetector`, `WorkflowRun`, `Agency`, `test_agent_runner.py`, `WorkspaceTools`, `.execute`, `workflow_orchestrator.py`, `BackgroundAgent`, `TokenBudget`, `test_agent_tool_governance.py`, `TestInternalAgentAdapterProviderChain`, `CEODispatcher`, `test_brain_failover_413.py`, `LocalWorkspace`, `PolicyDecision`, `get_ceo_dispatcher`, `GitHubTools`, `TestAgentLoopMCPIntegration`, `loop.py`, `test_agent_chat_integration.py`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderRouter` to `backend/server.py`, `system_instruction`, `test_failover_raises_503_when_all_fail`, `direct_chat.py`, `test_implement_agent_routing.py`, `test_all_providers_discovery.py`, `test_colibri_brain_shim.py`, `TrafficDirector`, `test_bedrock_live.py`, `test_bedrock_provider.py`, `failover_client.py`, `implement_agent.py`, `test_chat_mode_regressions.py`, `settings.py`, `ai/router.py`, `kimi_bridge_provider_config`, `TestRouterIntegration`, `TestLegacyRouterCacheTTL`, `test_anthropic_refusal_fallback.py`, `test_colibri_provider.py`, `TestAnthropicPayloadStructuredOutput`, `test_provider_router.py`, `TestLegacyRouterServerFallback`, `_payload`, `ProviderConfig`?**
