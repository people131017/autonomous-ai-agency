...
## Summary
- 32464 nodes · 66810 edges · 1284 communities (1105 shown, 179 thin omitted)
- Extraction: 90% EXTRACTED · 10% INFERRED · 0% AMBIGUOUS · INFERRED: 6597 edges (avg confidence: 0.93)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `12565bbd`
...
### Community 5 - "test_openclaw_endpoints.py"
Cohesion: 0.12
...
### Community 6 - "pytest"
Cohesion: 0.01
Nodes (120): parse_react_response(), Parse a ReAct-format response into structured components. Intended caller:…, importlib, Reset the singleton (test helper)., reset_watchdog(), pytest, tests/test_agency_fix.py — N3 acceptance tests for scripts/agency_fix.py. The…, An edit that produces a syntactically-broken Python file must be rejected —… (+112 more)

### Community 7 - "CompanyGraphService"
Cohesion: 0.03
Nodes (100): Step 5 — Note real gaps instead of pretending they're solved, What this maps to (real code, not a generic scaffold), ApprovalPolicy, BusinessSystem, CompanyCreateRequest, CompanyGraph, CompanyGraphSnapshot, CompanyResponse (+92 more)

### Community 8 - "failover_client.py"
Cohesion: 0.02
Nodes (145): brain_failover_status(), brain_providers(), Return the brain failover health snapshot. Shows every configured provider, its…, Every configured provider with its health AND its on/off state. Powers the…, Turn a provider on or off. Manual re-enable clears an auto-disable. Auto-…, seed_default_providers(), set_brain_provider_enabled(), ma() (+137 more)

### Community 9 - "api.js"
Cohesion: 0.01
Nodes (49): approveGovernanceRequest(), approveWorkflow(), autoRecommendCompanySkills(), cancelWorkflow(), createMcpServer(), createQuickNote(), createTask(), deleteGithubToken() (+41 more)

### Community 10 - "RuntimeAdapter"
Cohesion: 0.03
Nodes (59): Architecture, Modules, E2BAdapter, Any, Declare ``E2B_API_KEY`` as a required env dependency. The base ``preflight``…, Runtime adapter that executes tasks inside an E2B sandbox. Activation:…, Abstract base class every runtime adapter must implement. Subclasses must set…, Execute a task and return the result. Must handle its own timeout… (+51 more)

### Community 11 - "test_llm_router_queue_cache.py"
Cohesion: 0.02
Nodes (106): CacheManager, cosine_similarity(), _Entry, LRUCache, Any, T, Live (unexpired) entries — used by the semantic layer's scan., Cosine similarity between two vectors, 0.0 when either is degenerate. (+98 more)

### Community 12 - "proxy.py"
Cohesion: 0.03
Nodes (156): Describes a single worker's task and constraints., WorkerSpec, set_quick_note_queue(), get_sam(), fastapi_middleware_cors, _estimate_tokens_for_messages(), Estimate input token count for an Anthropic-format message list. Uses a simple…, middleware (+148 more)

### Community 13 - "config.py"
Cohesion: 0.03
Nodes (121): count, Preferring local, Choosing one, Latency got worse, _apply_env_overrides(), _apply_key_env(), _build(), _coerce() (+113 more)

### Community 14 - "AgentRunner"
Cohesion: 0.02
Nodes (102): Adding a new tool, CLAUDE.md — agent/, Security surface, Skills worth invoking here, Testing, What this package does, AgentRunner, _run() (+94 more)

### Community 15 - "LLMRequest"
Cohesion: 0.03
Nodes (112): ProviderConfig, One configured endpoint. ``kind`` selects the adapter: ``openai`` (any OpenAI-…, packages_llm_providers, OpenAICompatible, Any, AsyncClient, Perform one completion. Raises ``PermanentError``/``TransientError``., Yield normalised chunks for one streaming completion. (+104 more)
...
### Community 17 - "activation_api.py"
Cohesion: 0.03
Nodes (126): activation_required(), ActivationResult, activate_instance(), ActivateRequest, ActivateResponse, activation_audit_log(), activation_status(), ActivationStatusResponse (+118 more)

### Community 18 - "Changed"
Cohesion: 0.04
Nodes (112): _close_github_issue(), _fetch_github_quick_notes(), _gh_repo(), Return the GitHub repo in 'owner/name' format. Priority: 1. GITHUB_REPOSITORY…, Return ALL open GitHub issues for this repo (not just 'quick-note' labelled).…, Public wrapper around _generate_plan for callers that want plan-only. Returns…, _fast_count(), Count without materialising rows — prefers estimated_document_count. (+104 more)

### Community 19 - "test_operational_incidents.py"
Cohesion: 0.02
Nodes (121): _diagnose_and_file(), _format_incident(), gather_render_evidence(), get_operational_incident_tracker(), _iso_from_monotonic(), normalise(), note_phase_end(), note_phase_start() (+113 more)

### Community 20 - "telegram_bot.py"
Cohesion: 0.03
Nodes (120): loops_overview(), Full Loop Engineering fleet view for the UI: the catalogued loops plus the…, _get_cached_tasks(), _get_tasks_cache_lock(), Lock, Return cached task dicts; fetches + caches from TaskStore when stale. Uses…, Security, Security (+112 more)

### Community 21 - "Added"
Cohesion: 0.02
Nodes (100): get_enrichment(), Build the complete enrichment block (tools + skills). Returns empty string when…, Return the enrichment instance for a workspace. Keyed by workspace root rather…, Inject available tools + skills catalog into the system message.…, Tool Parameters, Added, Changed, Tool Parameters (+92 more)

### Community 22 - "Settings"
Cohesion: 0.02
Nodes (89): CatalogActiveBrain, CatalogMirror, CatalogProviderEntry, _include_router_providers(), invalidate_catalog_cache(), ModelCatalogStore, Any, BaseModel (+81 more)
...
### Community 25 - "setup/api.py"
Cohesion: 0.04
Nodes (94): is_user_onboarding_allowed(), Return True if this user may run the onboarding wizard. Resolution order: 1. If…, motor_motor_asyncio, audit(), get_audit_log(), Append an audit log entry. Never logs raw secrets — only secret IDs / masked…, Return recent audit log entries, newest first. Supports filtering by user_id,…, Confirm the primary session (+86 more)

### Community 26 - "SQLiteStore"
Cohesion: 0.03
Nodes (62): DetectedSystem, A business system detected on a company's website or in their stack., Get the most confident evidence description., Prepare a Pydantic model for SQLite storage., Prepare a SQLite row for Pydantic model., Create a new company in SQLite., Get a company by ID from SQLite., Update a company in SQLite. (+54 more)

### Community 27 - "_fixture"
Cohesion: 0.02
Nodes (94): _clear_discovered_models(), _clear_response_cache(), Default all tests to legacy workflow mode (Phase 2 compatibility). Only patches…, Drop the per-provider model listings between tests.…, Clear the LRU+TTL response cache between tests to prevent cross-test…, _set_legacy_workflow_mode(), base_url(), mobile_page() (+86 more)

### Community 28 - "test_governance_sandbox.py"
Cohesion: 0.04
Nodes (74): 1.11 Multi-Agent Governance (10 / 100 / 1000 agents), Failure behaviour, build_docker_run_argv(), detect_backend(), DockerBackend, E2BBackend, load_profiles(), LocalBackend (+66 more)

### Community 29 - "PolicyEngine"
Cohesion: 0.04
Nodes (88): fnmatch, _coerce_text(), new_session_id(), packages/governance/identity.py — who is acting, and under what mandate. Docker…, Best-effort text from a loosely-typed context value. Never raises. Identity is…, Return the stable ``agent:<slug>`` id for a human agent name. Deterministic and…, Return a fresh, unguessable session id. Unguessable matters because the session…, slugify_agent() (+80 more)

### Community 30 - "gateway.py"
Cohesion: 0.03
Nodes (89): packages_llm, get_budget(), The process-wide budget tracker., get_cache(), packages/llm/cache.py — layered caching. Five independent layers, each with its…, The process-wide cache manager., openai_body_from_response(), Any (+81 more)

### Community 31 - "test_ceo_micromanager.py"
Cohesion: 0.05
Nodes (98): Split the request into briefed, tier-assigned specialist sub-tasks. Returns the…, build_subtask_brief(), _coerce_subtasks(), decompose(), _extract_json_object(), fallback_decomposition(), MicroManagerConfig, next_tier() (+90 more)

### Community 32 - "start_background_services"
Cohesion: 0.03
Nodes (82): Short label for TUI display: {NAME}:{model}, _bootstrap_within_budget(), _create_bootstrap_indexes(), ensure_bootstrap(), lifespan(), _maybe_boot_purge(), _purge_summary_clean(), Await one warm-up step, deferring it to the background if it overruns.… (+74 more)

### Community 33 - "TaskStatus"
Cohesion: 0.04
Nodes (73): Submit a quick note instruction. Creates a Task with task_type='quick_note'., v4_quick_notes_submit(), Companies without a connected repo (URL-only onboarding), Creates tasks from scheduler and playbook runs using one workflow., TaskAutomationService, TaskStatus, Re-run a task. Permissive across every non-active state so the dashboard Retry…, Add a follow-up instruction to a task and re-queue it for execution. Unlike… (+65 more)

### Community 34 - "TaskSpec"
Cohesion: 0.06
Nodes (63): abc, kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, AiderAdapter, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Run aider non-interactively via `--message` flag., Adapter for Aider — TIER 3 specialized git-aware code editor., json_safe() (+55 more)

### Community 35 - "agency_fix.py"
Cohesion: 0.03
Nodes (84): date, build_review_context(), _gh(), main(), Aggregate all review feedback for the PR into a single context string., ``(model_id, label)`` pairs, for callers that log a label., resolve_candidates(), .github/scripts/provider_policy.py — Read the durable provider policy from the… (+76 more)

### Community 36 - "AgentScheduler"
Cohesion: 0.03
Nodes (58): gc, AgentScheduler, _now(), Any, Reconstruct a ScheduledJob from its as_dict() output., Register, list, trigger, and delete cron-scheduled agent jobs. Usage:: sched =…, Register a new job. Returns the created :class:`ScheduledJob`.…, Fire a job immediately (webhook / manual trigger). (+50 more)

### Community 37 - "Threat Model — Autonomous Agent Execution"
Cohesion: 0.29
...
Cohesion: 0.04
Nodes (89): CEOResult, Aggregated output from a multi-specialist execution., ClassifyOutput, ExecutionResult, get_ceo_fallback_stats(), PlanOutput, BaseModel, CLASSIFY phase: domain and task type determination. (+81 more)
...
### Community 40 - "looks_like_secret_file"
Cohesion: 0.04
Nodes (78): onboarding_gate_enabled(), Async read of the gate default straight from the DB., Removed, Removed, Removed, Removed, 0. The goal (unchanged), 1. Shipped in the previous pass ✅ (recap, do not redo) (+70 more)

### Community 41 - "CompanyGraphStore"
Cohesion: 0.03
...
Cohesion: 0.05
Nodes (51): get_mcp_client(), Return the module-level MCPClient. Reads MCP_SERVER_BASE_URL at call time (not…, Playwright, The MCP registry — one catalogue, measured status, _internal_configured(), list_specs(), MCPServerSpec, _not_dialable() (+43 more)

### Community 43 - "build_governance_router"
Cohesion: 0.06
Nodes (58): Charge sub-agent nesting depth and enforce the ``max_depth`` ceiling. Isolates…, build_governance_router(), approve(), _decide(), deny(), destroy_sandbox(), get_audit(), get_budget() (+50 more)

### Community 44 - "test_scanner_headless.py"
Cohesion: 0.03
Nodes (31): 5. Input Validation, A repeated key in a dict literal is silent: the later value wins. Found on…, TestTheCostTableHasNoDuplicateKeys, Tests for the scanner's headless-render fallback (JS-rendered / bot-protected…, The scan flow must invoke the render fallback when static detection is empty…, BuiltWith-style off-site identification: a CNAME chain that points at a known…, A scan must never hang past its wall-clock budget — a slow/blocked domain has…, Last-resort fallback that asks builtwith.com what it already knows about a… (+23 more)

### Community 45 - "test_agent_runner.py"
Cohesion: 0.04
...
### Community 46 - "Fixed"
Cohesion: 0.04
Nodes (57): Atomically delete a run-once row only while it is still unfired. Closes the…, E2: Classify a failure from its description text. Order matters:…, _in_container(), Called by APScheduler when a cron fires. Dispatches to the orchestrator. This…, Return True when running inside a container runtime. ``/.dockerenv`` alone…, _scheduler_on_fire(), Fixed, Fixed (+49 more)

### Community 47 - "Task"
Cohesion: 0.05
Nodes (49): ApprovalCheckpoint, Full task/issue document., Human approval gate in a task's execution., Task, Any, One-line human explanation of why this task needs human approval. Reads risk…, Best-effort label of who will run this task once approved. Returns…, PUBLIC_URL-anchored dashboard deep link for the task detail. Returns empty… (+41 more)
...
### Community 50 - "test_llm_router_resilience.py"
Cohesion: 0.04
...
### Community 53 - "ai/router.py"
Cohesion: 0.04
Nodes (59): clear_cooldowns(), _dead_model_key(), _exponential_backoff_cooldown(), _is_model_dead(), is_provider_on_cooldown(), mark_provider_failed(), provider_router.py — auto-generated module docstring (user-research skill scan)., Put provider_id on cooldown for *cooldown_seconds* (default:… (+51 more)

### Community 54 - "FreeBuffAgent"
Cohesion: 0.04
Nodes (57): free_nvidia_models(), FreeBuffAgent, _nvidia_api_key(), Return the curated list of free NVIDIA NIM models FreeBuff may use., Codebuff-style coding agent pinned to free NVIDIA NIM models. FreeBuff is a…, List the free NVIDIA NIM models a user may pick (e.g. via Telegram)., True when *model* is in the curated free NVIDIA NIM set., Coerce *requested* to a free NVIDIA model. Returns *requested* when it is… (+49 more)

### Community 55 - "resolve_component_model"
Cohesion: 0.03
...
### Community 57 - "AgentDefinition"
Cohesion: 0.04
Nodes (51): AgentDefinition, AgentStore, Any, field_validator, CRUD store for AgentDefinition objects. Uses MongoDB when a `db` client is…, Return an agent by ID. If *owner_id* is provided, enforces that the agent…, Delete an agent. Returns True on success, False if not found/unauthorised., Return all agents owned by *owner_id*, optionally including public agents. (+43 more)

### Community 58 - "validate_policy_text"
Cohesion: 0.05
Nodes (38): packages_governance, _audit_proposal(), _baseline_loosened(), _baseline_patterns(), diff_policy(), _GitHub, parse_policy_text(), _pr_body() (+30 more)

### Community 59 - "Usage"
Cohesion: 0.05
Nodes (37): AlertHandler, BudgetTracker, Counter, _Dimensions, _month(), Any, packages/llm/budget.py — token and cost accounting with spend alerts. Tracks…, Register a callback fired when a spend threshold is crossed. (+29 more)

### Community 60 - "WebsiteScanner"
Cohesion: 0.04
Nodes (58): pytest_asyncio, main(), Post-deploy verification for the website scanner against the LIVE internet.…, Returns (url, ok, summary)., _scan_one(), _is_safe_url(), Advanced Scanner for detecting technology stack and systems from websites.…, Block SSRF: reject loopback, link-local, private, and non-HTTP schemes. (+50 more)
...
### Community 64 - "SelfHealingAgent"
Cohesion: 0.05
Nodes (45): HealingEvent, _now(), Any, Translate external failure signals into improvement tasks and verify the fix…, Launch the background sweeper that resolves quiet verifying heals., Called when a CI workflow fails., Called when a GitHub issue with a bug label is opened., Called from the v4 dashboard 'Report Bug' form and the LogMonitor.… (+37 more)

### Community 65 - "ref_react"
Cohesion: 0.05
Nodes (37): Removed, Removed, getAccountLifecycle(), getMe(), login(), logout(), App(), AppRoutes() (+29 more)
...
### Community 67 - "webui/router.py"
Cohesion: 0.04
Nodes (66): dotenv, fastapi_responses, fastapi_staticfiles, BaseModel, post, Autonomous AI Agency Launcher - One-button service start with web UI. Run this…, start_proxy(), start_tunnel() (+58 more)
...
### Community 72 - "ExecutionRequest"
Cohesion: 0.06
Nodes (39): stop_orchestrator_supervisor(), ExecutionRequest, get_workflow_orchestrator(), Return the shared WorkflowOrchestrator singleton., Reset the singleton (test helper)., Canonical request to execute work through the golden path. This is the ONLY…, reset_orchestrator(), ExecutionRequest exposes worktree_path for #504 worktree isolation. (+31 more)

### Community 73 - "_start_autonomy_loops"
Cohesion: 0.05
Nodes (58): _dispatch_async(), _run(), _ErrorCaptureHandler, get_log_monitor(), LogMonitor, _note_recurrence(), LogRecord, Register the error capture handler on the root logger. (+50 more)

### Community 74 - "RepowiseIntelligence"
Cohesion: 0.04
Nodes (44): Any, Path, Build symbol-level dependency graph for Python files., Build git intelligence: hotspots, ownership, co-change pairs., Run a git command and return stdout as string., Compute cyclomatic complexity for Python files. Returns 0 for non-Python files…, Extract docstrings and store as documentation., Get the latest commit hash. (+36 more)

### Community 75 - "V5App.jsx"
Cohesion: 0.04
Nodes (42): Fixed, API, buildWorkflow(), getWorkflowRuns(), V5App, HubTabs(), Spinner(), ActivationGate() (+34 more)

### Community 76 - "Fixed"
Cohesion: 0.05
Nodes (56): Normalise a raw planner JSON response into a consistent plan dict. Handles: -…, build_compaction_prompt(), build_execution_prompt(), build_planning_prompt(), build_tool_prompt(), build_verification_prompt(), Any, prompts.py — Prompt builders for planner, executor, and verifier roles. (+48 more)

### Community 77 - "_StubProvider"
Cohesion: 0.06
...
### Community 78 - "test_daily_digest.py"
Cohesion: 0.06
...
### Community 79 - "AgentSwarm"
Cohesion: 0.07
Nodes (36): agents/__init__.py — CRISPY multi-agent coding system., AgentProfile, _catalog_provider(), _get_defaults(), load_all_profiles(), make_architect_profile(), make_coder_profile(), make_reviewer_profile() (+28 more)

### Community 80 - "NotificationDispatcher"
Cohesion: 0.05
Nodes (45): Acceptance criteria, Design, Objective, Part B — G2: Closed-loop self-heal feedback, Tech stack / touch points, Tests, To-dos (checklist), NotificationDispatcher (+37 more)

### Community 81 - "ProviderRouter"
Cohesion: 0.05
Nodes (28): ProviderRouter, Priority-ordered LLM provider fallback with health checks and retries., main(), probe_one(), _bedrock_api_response(), _bedrock_provider(), _mock_boto3(), Any (+20 more)

### Community 82 - "resolve_e2b_config"
Cohesion: 0.05
...
### Community 83 - "test_e2e_agent_chat.py"
Cohesion: 0.08
...
Cohesion: 0.06
Nodes (55): audit_drift(), _cmd_audit(), DriftReport, _grade(), load_registry(), load_registry_sync(), loop_readiness(), LoopRegistry (+47 more)

### Community 85 - "test_web_reach.py"
Cohesion: 0.06
Nodes (50): _domain_list_reason(), Return why the env-var domain policy blocks *host*, or None. Checks…, Zero-key internet access: pages, YouTube transcripts, search, RSS. Every public…, WebReach, _fake_fetch_module(), _fake_video_module(), ModuleType, MonkeyPatch (+42 more)
...
Cohesion: 0.04
Nodes (60): get_agency(), _gh_token(), set_agency(), _autonomy_bg_cycle(), autonomy_status(), autonomy_tick(), legacy_scheduler_delete(), legacy_scheduler_get() (+52 more)

### Community 88 - "CEODispatcher"
Cohesion: 0.06
Nodes (46): True if any path matches the repo's risky-module trigger list., touches_risky_module(), CEODispatcher, _runner_factory(), _complexity_rank(), _decompose_into_subtasks(), _offload(), Any (+38 more)

### Community 89 - "DashboardScreen.jsx"
Cohesion: 0.04
Nodes (30): createSchedule(), pauseSchedule(), resumeSchedule(), triggerSchedule(), Charts, Donut(), ExecutionTimeline(), Sparkline() (+22 more)

### Community 90 - "scanner.py"
Cohesion: 0.05
...
### Community 92 - "services/background.py"
Cohesion: 0.05
Nodes (43): get_skill_registry_safe(), Return the global SkillRegistry if set, else None. Used by onboarding and other…, ctypes_util, _await_hermes_ready(), _env_on(), Any, services/background.py — shared background-service startup. Both the FastAPI…, Await the refresh and log the outcome; swallow every failure. (+35 more)

### Community 93 - ".apply_diff"
Cohesion: 0.03
Nodes (57): 1. The Rules, A. Prime directive, Activation, Agent: Reviewer (Verifier), Blocking Conditions (must return `fail`), Handoff, Key Invariant, Non-Blocking (may return `pass` with suggestions) (+49 more)

### Community 94 - "test_v4_reliability.py"
Cohesion: 0.05
Nodes (33): _is_trivial_message(), Detect simple greetings/replies to avoid unnecessary agent promotion., Fail preflight when the provider extension is configured but missing. Without…, Any, Structured, actionable preflight validation issue., Preflight result returned before a runtime task starts., Return runtime-specific dependency declarations for preflight., Return a best-effort tool availability report for diagnostics. (+25 more)
...
### Community 96 - "Company"
Cohesion: 0.06
Nodes (20): BusinessCategory, Company, Any, field_validator, The core company entity - root of the Company Graph., Coerce unrecognised system_type values to 'custom' so the model never crashes…, Get a company by ID. Args: company_id: Company ID Returns: Company instance or…, Update a company. Args: company_id: Company ID **kwargs: Fields to update… (+12 more)

### Community 97 - "FeatureMatrix"
Cohesion: 0.05
...
### Community 98 - "test_colibri_brain_shim.py"
Cohesion: 0.05
...
### Community 99 - "test_persistent_memory.py"
Cohesion: 0.05
Nodes (58): MemoryCategory, MemoryScope, Enum, Row, str, Memory categories for semantic organization., Memory scope determines when memory is auto-loaded., cmd_autoload() (+50 more)
...
### Community 101 - "AnthropicProvider"
Cohesion: 0.08
...
### Community 103 - "test_all_features.py"
Cohesion: 0.03
...
### Community 105 - "BrowserSession"
Cohesion: 0.05
Nodes (35): browse_page(), BrowserAction, BrowserSession, _not_started(), PageState, Any, agent/browser.py — Browser Automation Controls a real browser via Playwright so…, Which backend a start() would use: 'browserbase', 'local', or 'stub'. (+27 more)

### Community 106 - "MCPClient"
Cohesion: 0.05
Nodes (24): MCPClient, Any, Thin async MCP client with open/close circuit breaker. Thread-safe only within…, Full URL of the JSON-RPC endpoint this client posts to., Build the request headers shared by ``_rpc`` and ``notify``. ``Accept`` lists…, Propagate the calling agent's identity across the process boundary. The MCP…, Attach the agent identity whose actions this client executes., Send a JSON-RPC notification (no ``id``, no response body expected). Used for… (+16 more)

### Community 107 - "TokenBudget"
Cohesion: 0.05
Nodes (33): BudgetUsage, Any, Raise :class:`BudgetExceededError` if the session has exceeded its cap., Reset usage counters for *session_id* (cap is preserved)., Generate a token savings analytics report. Returns per-session statistics and…, Track and enforce per-session or per-agent token budgets. Usage:: budget =…, Set (or update) the token cap for *session_id*., Add token counts for *session_id*. If *response_text* is given and counts are… (+25 more)
...
### Community 109 - "test_repo_connection.py"
Cohesion: 0.07
Nodes (51): Phase 0 — `RepoConnection` plumbing + delivery-policy detection, 6. Integration gaps to wire (follow-up implementation), Loop 3 — Agentic SDLC (the golden path), Acceptance criteria, Design, Objective, Part E — G5: `RepoConnection` + `DeliveryPolicy` (GitHub-only scope), Tech stack / touch points (+43 more)

### Community 110 - "KnowledgeScreen.jsx"
Cohesion: 0.04
...
### Community 114 - "WorkspaceManager"
Cohesion: 0.05
...
### Community 116 - "company_api.py"
Cohesion: 0.02
Nodes (176): ephemeral_ttl_hours(), Async read of the ephemeral TTL (hours) straight from the DB., account_lifecycle(), AccountLifecycleResponse, auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint() (+168 more)

### Community 117 - "RenderOpsMonitor"
Cohesion: 0.08
...
### Community 118 - "_resolve_brain_provider"
Cohesion: 0.05
...
### Community 119 - "gsap.min.js"
Cohesion: 0.05
Nodes (33): Context(), Db(), Eb(), fb(), Hc(), ia(), Ic(), ie() (+25 more)

### Community 120 - "ArtifactStore"
Cohesion: 0.07
Nodes (27): Path, tests/test_artifact_store.py — Unit tests for workflow/artifact_store.py., Verify artifacts that are stored as JSON (e.g., CheckRun results)., Writing the same (run_id, name) twice should update, not duplicate., store(), TestArtifactStoreDeletion, TestArtifactStoreJSONArtifact, TestArtifactStoreListing (+19 more)
...
### Community 125 - "WorkflowOrchestrator"
Cohesion: 0.05
Nodes (29): Changed, Changed, Feature maturity — what's stable vs. beta, Actively wake every sleeping/circuit-open runtime. The default health service…, Determine domain and task type from the request text., Generate a structured execution plan. Uses the LLM if available; falls back to…, Select the best specialist(s) for the classified domain., Produce a human-readable summary with evidence. (+21 more)

### Community 126 - "LogWatcher"
Cohesion: 0.05
...
### Community 127 - "HttpxFetcher"
Cohesion: 0.05
Nodes (19): MockTransport, BrowserFetcher, FetchResult, HttpxFetcher, AsyncBaseTransport, Browser backend: renders pages with a real Chromium via Playwright. This is the…, Tries the primary (httpx) backend; escalates to a browser on bot-block. This is…, Normalised result of fetching one URL, regardless of backend. (+11 more)

### Community 128 - "SeoAuditEngine"
Cohesion: 0.07
...
### Community 130 - "runtimes/api.py"
Cohesion: 0.06
Nodes (48): _enrich_runtimes(), get_policy(), _load_rich_policy(), PolicyUpdateBody, Any, BaseModel, post, put (+40 more)

### Community 131 - "NIMConnectionPool"
Cohesion: 0.05
Nodes (25): NIMConnectionPool, ProviderCircuit, Any, AsyncClient, Attempt to move from OPEN to HALF_OPEN after recovery timeout., Check if a request can be made through this circuit., Persistent httpx.AsyncClient pool with circuit breaker and retry logic. Manages…, Get or create the shared httpx.AsyncClient. (+17 more)

### Community 132 - "render_ops.py"
Cohesion: 0.05
...
Cohesion: 0.07
Nodes (53): _blocked_retire_age_sec(), _heal_blocked_backlog(), _heal_brain_failover(), _heal_purge_backlog(), _heal_stuck_tasks(), _heal_task_duplicates(), _heal_telegram(), _heal_timestamps() (+45 more)
...
### Community 135 - "_Response"
Cohesion: 0.05
Nodes (33): _dispatch_async(), _run(), ErrorInterceptorMiddleware, Any, BaseHTTPMiddleware, Exception, Request, Catch 5xx responses and auto-create fix tasks via the self-healing agent.… (+25 more)

### Community 136 - "Current Sprint Tasks"
Cohesion: 0.06
Nodes (46): Perform MCP handshake. Optional — tools/call works without it., Fixed, Fixed, Active Task Tracker, Bug Log, Current Sprint Tasks, Roadmap Items (from `docs/roadmap-killer-todos.md`), Carry-over items (from prior sessions) (+38 more)

### Community 137 - "model_router.py"
Cohesion: 0.06
Nodes (32): F. Router invariants (`router/`), F. Router invariants (`router/`), fallback_chain(), Follow the explicit chain in ``routing.yaml``, then everything else. The chain…, _build_builtin_model_map(), _default_model(), _nvidia_key_present(), Any (+24 more)

### Community 138 - "InternalAgentAdapter"
Cohesion: 0.06
...
### Community 139 - "test_mcp_governance.py"
Cohesion: 0.06
Nodes (49): Replace the process-wide store. Tests only., reset_approval_store(), get_audit_log(), Return the process-wide audit log, created on first use., Replace the process-wide audit log. Tests only., reset_audit_log(), Replace the process-wide engine. Tests only., reset_policy_engine() (+41 more)

### Community 140 - "test_trend_watcher.py"
Cohesion: 0.06
...
### Community 141 - "AgentPlan"
Cohesion: 0.05
Nodes (33): AgentPlan, AgentStep, Activation, Agent: Planner (Architect), Failure Behaviour, Handoff, Output Format, Preferred Model (+25 more)

### Community 142 - "AgileSprint"
Cohesion: 0.06
...
### Community 146 - "TestAddConversationCacheBreakpoints"
Cohesion: 0.05
...
### Community 148 - "test_platform_controls.py"
Cohesion: 0.05
Nodes (43): apply_overrides(), Write *overrides* into ``os.environ`` and refresh dependent caches. Keys that…, Re-read every ``settings`` attribute from the updated environment. Re-runs…, _refresh_settings_singleton(), all_controls(), controls_by_group(), get_control(), is_controllable() (+35 more)
...
### Community 150 - "get_runtime_manager"
Cohesion: 0.06
Nodes (44): DirectChatDoctor, _chat_provider_policy(), _DoctorCheck, _DoctorReport, get_doctor_diagnostics(), get_doctor_report(), get_public_doctor(), Consolidated system health report: preflight checks + runtime health. Returns a… (+36 more)
...
### Community 152 - "test_autonomous_agency_e2e.py"
Cohesion: 0.04
Nodes (24): AutonomyCounter, AutonomySnapshot, AutonomyTracker, Any, Return a point-in-time snapshot of all KPIs., Reset all counters (test helper)., Thread-safe counter for a single KPI metric., Point-in-time snapshot of all autonomy KPIs. (+16 more)
...
### Community 155 - "E2BSandboxSession"
Cohesion: 0.08
...
### Community 157 - "BackgroundAgent"
Cohesion: 0.07
Nodes (32): BackgroundAgent, heartbeat(), BackgroundTask, _now(), Any, Enqueue *task* for processing. Returns the task (with task_id set)., Convenience: create a task and submit it in one call., Real handler — dispatches through AgentRunner when available. HARDENED (PR… (+24 more)

### Community 158 - "KeyStore"
Cohesion: 0.07
...
### Community 160 - "test_issue_intake.py"
Cohesion: 0.08
...
### Community 161 - "test_agency.py"
Cohesion: 0.09
Nodes (47): AgentRole, _parse_ceo_directives(), Enum, str, set_improvement_loop(), Session Log, Configuration, Deploying on Render (+39 more)

### Community 162 - "test_direct_chat_evolution.py"
Cohesion: 0.07
Nodes (49): AcceptedJob, AgentJobEnvelope, CompletedJob, DirectChatState, FailedJob, BaseModel, Enum, str (+41 more)

### Community 163 - "workflow_orchestrator.py"
Cohesion: 0.07
Nodes (38): contextvars, BoundContext, JudgeVerdict, MergeDecision, MonitorOutput, _orchestrator_bypass(), PersistOutput, Phase (+30 more)

### Community 164 - "ScheduleStore"
Cohesion: 0.06
...
### Community 165 - "Agency"
Cohesion: 0.06
Nodes (29): Agency, AgencyCycleResult, AgentDirective, _build_ceo_prompt(), _build_quick_note_instruction(), _collect_recent_git_context(), _now_str(), Any (+21 more)

### Community 166 - "TrafficDirector"
Cohesion: 0.08
...
### Community 167 - "chat_handlers.py"
Cohesion: 0.08
Nodes (42): Layer 2 — Chat Handlers (`chat_handlers.py`, 710 lines), _apply_chat_defaults(), _apply_reasoning_budget(), _emit_safely(), _extract_exact_output(), _filter_fragment(), _filter_openai_sse_line(), handle_ollama_native_chat() (+34 more)
...
### Community 169 - "test_e2b_data_flow.py"
Cohesion: 0.06
...
### Community 172 - "facade.py"
Cohesion: 0.07
Nodes (43): create_refresh_token(), google_callback(), Return True if a fetched oauth_states doc is a valid, unexpired login state., _valid_login_state(), create_access_token(), create_refresh_token(), get_current_user(), get_optional_user() (+35 more)

### Community 173 - "_untried_paid"
Cohesion: 0.06
...
### Community 175 - "ModelRegistry"
Cohesion: 0.07
Nodes (17): ModelRegistry, Add or replace a model (used by runtime discovery)., The biggest-context model available — the context-overflow escape hatch., The lowest-cost model that still meets the requirements., The fastest model by declared speed tier., Serialisable view for the dashboard and the ``/v1/models`` route., A copy of ``model`` bound to a different provider (cross-provider reuse)., Capability-aware lookup over the configured models. (+9 more)
...
### Community 179 - "probe_model_liveness"
Cohesion: 0.07
...
### Community 182 - "test_trend_scoping.py"
Cohesion: 0.11
...
### Community 183 - "PatternConsolidation"
Cohesion: 0.08
...
### Community 184 - "test_governance_api.py"
Cohesion: 0.07
...
### Community 185 - "test_telegram_freebuff.py"
Cohesion: 0.07
Nodes (38): Workflow Orchestrator Approval Gate (🔴 Telegram gate), _parse_callback(), _parse_user_ids(), _process_callback(), Accept / reject keyboard shown after a FreeBuff plan is generated., Handle an inline-button press for the FreeBuff accept/reject/model flow., Extract numeric Telegram user IDs from a raw env value, tolerantly. Accepts…, Resolve the ALLOWED/ADMIN Telegram user-ID sets. ``TELEGRAM_CHAT_ID`` is the… (+30 more)

### Community 186 - "traffic_director.py"
Cohesion: 0.07
Nodes (36): Pre-call budget checks, provider_max_parallel(), provider_max_rpm(), provider_max_tpm(), _provider_positive_float(), provider_weight(), Shared parse/validate for the numeric per-provider traffic budgets. Returns…, Return the operator-configured requests/min cap for *provider*, or None if… (+28 more)
...
### Community 190 - "test_shared_state.py"
Cohesion: 0.08
...
### Community 191 - "test_dependabot_sweep_workflow.py"
Cohesion: 0.05
...
### Community 192 - "test_video_transcript.py"
Cohesion: 0.05
...
### Community 195 - "test_daily_2026_07_27.py"
Cohesion: 0.07
...
### Community 196 - "resolve_provider_for"
Cohesion: 0.06
...
### Community 201 - "test_response_cache.py"
Cohesion: 0.13
...
### Community 203 - "test_runtime_governance.py"
Cohesion: 0.12
...
### Community 204 - "ManagedAgentDreams"
Cohesion: 0.06
...
### Community 205 - "PromptCacheManager"
Cohesion: 0.06
...
### Community 207 - "portfolio_intelligence.py"
Cohesion: 0.08
Nodes (38): generate_standup(), Build a :class:`StandupReport` from ``.claude/state/active-tasks.md``. Reads…, _bug_scores(), _clean(), _default_repo(), _env_github_token(), estimate_job_size(), fetch_github_signals() (+30 more)

### Community 208 - "KnowledgeGraph"
Cohesion: 0.08
...
Cohesion: 0.08
Nodes (25): Exception, Approve a run paused at the ApprovalGate. The caller must re-invoke…, In-flight state for a single golden-path execution., Run a phase with timeout, retries, and provider provenance tracking (#522).…, True when this error class is worth retrying (transient)., Execute a request through the full golden path. Blocks at ApprovalGate unless…, Approve a run paused at the ApprovalGate and resume execution. Returns the…, #522: Approve a run and enqueue it for async execution via the FIFO queue.… (+17 more)

### Community 213 - "test_e2b_adapter.py"
Cohesion: 0.07
Nodes (33): _clean_e2b_env(), _FakeAsyncSandboxClass, _FakeCommandResult, _FakeCommands, _FakeFiles, _FakeSandbox, patched_async_sandbox(), Any (+25 more)
...
### Community 215 - "test_verification_strategies.py"
Cohesion: 0.08
Nodes (36): agent, cross_verify(), Any, race(), Heuristic fallback score when the reward model is unavailable.…, Run *n* independent attempts at *instruction* concurrently; return the winner.…, Have an independent agent re-check a completed task's changed files. Returns…, _score_attempt() (+28 more)

### Community 216 - "user_research_skill.py"
Cohesion: 0.09
Nodes (36): get_tool_registry(), Return the module-level ToolRegistry singleton. On first call, registers built-…, auto_register(), _classify_sentiment(), _extract_keywords(), BaseModel, QualAnalysis, QualQuote (+28 more)

### Community 217 - "WorkspaceTools"
Cohesion: 0.06
Nodes (26): Path, Return the first *lines* lines of a file. Just-in-time retrieval: the executor…, Return a lightweight index of files with line counts and sizes. This is the…, Delegate to RepowiseIntelligence for a natural-language codebase question., Delegate to RepowiseIntelligence for a semantic/text codebase search., Delegate to RepowiseIntelligence to list architectural decision nodes., Return a high-level repository map and hotspot summary., Return a formatted context block for the given file paths. (+18 more)

### Community 218 - "TrendWatcher"
Cohesion: 0.14
...
### Community 219 - "agents/agile_ceremonies.py"
Cohesion: 0.06
Nodes (33): _bullets(), generate_backlog_retro(), generate_sprint_retro(), plan_next_sprint(), Agentic Agile — autonomous ceremonies (standup, retro, sprint planning). Where…, Render a :class:`Retrospective` as a markdown section., Derive retro notes for ``sprint`` from its current metrics. Records…, Derive a retrospective from the task tracker when no sprint is active. DONE /… (+25 more)
...
### Community 223 - "control_overrides.py"
Cohesion: 0.08
...
### Community 231 - "TaskBoardScreen.jsx"
Cohesion: 0.06
Nodes (34): Key files, addTaskComment(), approveTaskCheckpoint(), approveTaskExecution(), clarifyTask(), createSprint(), escalateTask(), fetchSprints() (+26 more)

### Community 232 - "Persistent Memory System"
Cohesion: 0.05
...
### Community 233 - "Platform Guide — the full tour"
Cohesion: 0.05
...
### Community 236 - "test_iteration_6_features.py"
Cohesion: 0.06
...
### Community 237 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.05
...
Cohesion: 0.09
Nodes (20): Re-queue BLOCKED tasks that have cooled down and are ready for retry., Polls for queued task work and executes it through the coordinator. Crash…, Re-queue tasks stranded by a prior crash or hard-kill., TaskDispatcher, _make_task(), asyncio, A BLOCKED task with a recent ISO 8601 updated_at should be skipped (cooldown…, Build a task with a specific updated_at value (bypassing the validator). (+12 more)

### Community 239 - "_build_anthropic_response"
Cohesion: 0.08
Nodes (30): _build_anthropic_response(), _content_block_to_text(), _emit_safely(), _finish_reason_to_stop_reason(), handle_anthropic_messages(), _messages_to_openai(), _openai_choice_to_anthropic_content(), _post_anthropic_with_fallback() (+22 more)

### Community 240 - "CEOLedger"
Cohesion: 0.08
...
### Community 241 - "test_anthropic_router.py"
Cohesion: 0.08
...
Cohesion: 0.08
Nodes (34): True if browser automation is enabled and Playwright is importable., Precise string replacement — F1 roadmap item (Codebuff/Claude Code-style edit).…, _egress_policy_reason(), Return why governance policy blocks *host*, or None. Runs strictly *after* the…, GET *url*, re-validating every redirect hop against ``unsafe_target_reason`` —…, Return why *url* must not be fetched, or None if it's a safe public target.…, unsafe_target_reason(), Added (+26 more)
...
Cohesion: 0.06
Nodes (27): Added, Added, Added, Changed, Fixed, Fixed, Fixed, Fixed (+19 more)

### Community 247 - "test_daily_2026_06_04.py"
Cohesion: 0.08
Nodes (39): Changed, Changed, AdminOnboardingPanel(), ActivationPanel(), is_anthropic_model(), True when *model* names a paid Anthropic/Bedrock-Claude model. Covers native…, _opus_model(), Return an Opus model ID iff the operator explicitly opted into a paid brain.… (+31 more)

### Community 248 - "LLM Router — architecture"
Cohesion: 0.05
Nodes (36): 1. `LLMRouter` is the only gateway, 2. Providers are data, not code, 3. Secrets stay in the environment, 4. Three independent failure scopes, 5. Bulkhead isolation, 6. Context is managed losslessly, 7. Configuration is six committed YAML files, ADR-008: LLMRouter — the single multi-provider routing gateway (+28 more)

### Community 249 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.05
...
### Community 251 - "monitor_colibri.py"
Cohesion: 0.10
Nodes (38): ArgumentParser, build_parser(), cmd_autostart_install(), cmd_status(), cmd_supervise(), cmd_wait(), _configure_logging(), main() (+30 more)
...
### Community 253 - "test_chat_mode_regressions.py"
Cohesion: 0.08
Nodes (24): bson, ProviderAttempt, ProviderResult, _auth_headers(), test_agent_status_endpoint_reports_live_progress_and_tool_calls(), fake_agent_loop(), test_agent_stream_endpoint_emits_server_sent_events(), test_chat_send_emits_langfuse_observation_for_direct_chat() (+16 more)

### Community 254 - "allow_paid"
Cohesion: 0.06
Nodes (34): Example: Access your home PC models from any machine. Install: pip install…, 1. Mission & operating principles, 2. Brain policy (free cloud LLMs), 3. The Gate Matrix (core artifact), 5. The five autonomous loops, 7. Definition of "fully autonomous" — acceptance criteria, 8. Safety invariants (carried from `agent/CLAUDE.md`), 🟢 Autonomous — run, then notify-only (+26 more)

### Community 255 - "load_config"
Cohesion: 0.06
Nodes (40): Added, Added, config_dir(), load_config(), Path, Directory holding the YAML files., Read every YAML file and merge it over the environment-derived defaults., Normalise a configured ``kind`` to an adapter key. (+32 more)
...
### Community 258 - "WorkflowRun"
Cohesion: 0.09
Nodes (22): engine(), _fake_artifact(), _make_engine(), tests/test_crispy_workflow.py — CRISPY workflow engine hardening tests. Tests…, Create a WorkflowEngine with isolated storage., TestAbortOnFailure, _test(), _tracking_run_single() (+14 more)
...
### Community 261 - "test_telegram_webhook.py"
Cohesion: 0.06
...
### Community 264 - "test_control_plane_api.py"
Cohesion: 0.06
...
### Community 265 - "WorkflowBuildRequest"
Cohesion: 0.09
Nodes (21): Contract: WorkflowEngine cannot skip the gate state machine., Contract: No code path may advance past awaiting_approval unless gate.status ==…, Create a run and manually place it in awaiting_approval., Contract: Cannot approve a run in 'pending' state., Contract: Can approve a run in 'awaiting_approval' state., Contract: Rejecting a run marks it as failed., TestApprovalGateMandatory, do_approve() (+13 more)

### Community 266 - "TestCatalogFable51"
Cohesion: 0.09
...
### Community 267 - "test_local_controller.py"
Cohesion: 0.07
...
### Community 268 - "heal_signature"
Cohesion: 0.08
Nodes (26): FailureCategory, heal_signature(), HealState, Enum, str, Classified failure types for targeted self-healing (E2)., Lifecycle of a heal (Autonomy Charter G2 closed loop)., Stable signature for an error/heal, used to dedup and detect recurrence.… (+18 more)
...
### Community 271 - "AgentsScreen.jsx"
Cohesion: 0.06
...
### Community 274 - "Added"
Cohesion: 0.12
Nodes (17): Any, Force the next ``list_tools()`` call to fetch a fresh tool list from the…, Added, Added, Failure behaviour, BarChart(), CEOCyclePanel(), CostBreakdownWidget() (+9 more)
...
### Community 278 - "generate_context.py"
Cohesion: 0.09
...
### Community 279 - "system_instruction"
Cohesion: 0.09
Nodes (12): is_strict(), Any, Structured output normalization across LLM providers. Translates the OpenAI…, Return True when the caller has requested strict schema enforcement. Strict…, Return a plain-English JSON instruction for a ``response_format`` dict. Returns…, system_instruction(), Daily automation tests — 2026-07-24. Covers three features added in this…, is_strict() detects strict: true inside json_schema. (+4 more)

### Community 280 - "BrainWatchdog"
Cohesion: 0.08
...
### Community 282 - "test_brain_availability_doctor.py"
Cohesion: 0.11
...
### Community 284 - "state.py"
Cohesion: 0.09
Nodes (26): Agent subsystem — planner / executor / verifier loop., AgentEvent, AgentRunRequest, AgentSessionCreateRequest, AgentSessionMessage, _known_tool_names(), Any, BaseModel (+18 more)
...
### Community 290 - "PersistentMemoryStore"
Cohesion: 0.09
Nodes (19): MemoryEntry, PersistentMemoryStore, Any, Connection, Path, Save a memory entry with categorization and scoping., Recall a specific memory entry., Auto-load relevant memories based on context. Returns memories prioritized by:… (+11 more)

### Community 291 - "PlaybookLibrary"
Cohesion: 0.10
...
### Community 293 - "get_skill_bindings"
Cohesion: 0.09
...
### Community 294 - "TestRenderMCPClient"
Cohesion: 0.10
...
### Community 297 - "parse_event_stream"
Cohesion: 0.15
...
### Community 299 - "test_provider_enable_disable.py"
Cohesion: 0.07
...
Cohesion: 0.06
Nodes (32): Any, Return recent commits with agent attribution trailers parsed out., Agent governance — identity, policy, approvals, audit, sandboxes, Agent Models, Anthropic API Compatibility / Claude Code, Authentication and Keys, Claude Code setup, Configuration Reference (+24 more)

### Community 301 - "ContextCompressor"
Cohesion: 0.11
...
### Community 303 - "MCPUnavailableError"
Cohesion: 0.14
...
### Community 306 - "test_key_pool.py"
Cohesion: 0.08
...
### Community 307 - "test_brain_failover.py"
Cohesion: 0.12
...
### Community 312 - "TestAuthAndTaskOwnership"
Cohesion: 0.06
...
### Community 313 - "test_microagents.py"
Cohesion: 0.15
...
### Community 314 - "video_transcript.py"
Cohesion: 0.11
...
### Community 315 - "probe_catalogues.py"
Cohesion: 0.12
...
### Community 322 - "ExecutiveAdvisory"
Cohesion: 0.11
Nodes (16): _compose_context(), ExecOpinion, ExecutiveAdvisory, Grounding, Any, Evidence gathered for a question before the executives answer., One executive's answer to the question., Routes a business question to the right executives and synthesises them. (+8 more)

### Community 323 - "test_executive_advisory.py"
Cohesion: 0.11
Nodes (22): _format_company_context(), Coerce supplied company context to a compact string, or empty., _FakeMemory, asyncio, Tests for the intelligent C-suite advisory layer (agent/executive_advisory.py).…, Return an async llm that yields queued replies and records calls., _recording_llm(), test_advise_consults_selected_execs_and_synthesizes() (+14 more)
...
### Community 325 - "ResourceWatchdog"
Cohesion: 0.10
...
### Community 326 - "High-Agency Frontend Skill"
Cohesion: 0.06
...
### Community 328 - "tools"
Cohesion: 0.11
Nodes (25): Fixed, Fixed, Fixed, Fixed, Fixed, Fixed, DetailsStep(), _cache_key() (+17 more)
...
### Community 331 - "DistributedRateLimiter"
Cohesion: 0.09
...
### Community 338 - "Sampling Strategies Internals"
Cohesion: 0.07
...
### Community 340 - "control_registry.py"
Cohesion: 0.12
...
### Community 341 - "RuntimeHealthService"
Cohesion: 0.09
...
### Community 343 - "compare_runtimes.py"
Cohesion: 0.11
...
### Community 344 - "local_controller.py"
Cohesion: 0.13
...
### Community 349 - "test_rag_context.py"
Cohesion: 0.12
...
### Community 353 - "Conflicts and Stale Facts"
Cohesion: 0.07
...
### Community 354 - "Part A — CodeRabbit review fixes for this PR (do first, small)"
Cohesion: 0.07
...
### Community 355 - "SeoFixRequest"
Cohesion: 0.14
Nodes (10): Request to remediate auto-fixable findings in a local code repository., SeoFixRequest, Convenience wrapper used by the API layer and skill executor., run_fixes(), Path, tests/test_seo_fixer.py - repo-aware SEO auto-fixer tests (issue #533)., TestApply, TestDryRun (+2 more)
...
### Community 358 - "test_internal_agent_did_work.py"
Cohesion: 0.12
...
### Community 359 - "_captured_request_headers"
Cohesion: 0.12
...
### Community 361 - "test_harness_spec.py"
Cohesion: 0.14
...
### Community 362 - "test_agent_tools.py"
Cohesion: 0.11
...
### Community 366 - "Python Dependencies (`requirements.txt`)"
Cohesion: 0.07
...
### Community 367 - "build_render_router"
Cohesion: 0.12
...
### Community 368 - "RuntimeHealth"
Cohesion: 0.09
Nodes (13): Check whether Docker is available and report the adapter's runtime health.…, Health status snapshot for a runtime., Return a health snapshot. Must not raise; return available=False instead., RuntimeHealth, Some runtimes awake, some sleeping — both reported correctly., test_wake_all_sleeping_runtimes_mixed_state(), _poll(), End-to-end (router level): GET /runtimes/health returns JSON with a `health`… (+5 more)

### Community 369 - "ProviderConsole.jsx"
Cohesion: 0.08
...
### Community 370 - "validate_outbound_url"
Cohesion: 0.13
...
### Community 378 - "test_crispy_burn_in.py"
Cohesion: 0.08
...
### Community 379 - "ProjectScaffolder"
Cohesion: 0.14
...
### Community 382 - "Claude Code + Qwen Local Setup"
Cohesion: 0.07
...
### Community 383 - "Docker Agent Runtimes Setup"
Cohesion: 0.07
...
### Community 384 - "test_render_mcp.py"
Cohesion: 0.13
...
### Community 385 - "test_llm_router_disabled.py"
Cohesion: 0.14
Nodes (25): is_unfixable(), Whether this failure needs a human rather than a retry. Two shapes qualify. A…, _ok(), parametrize, The router must honour the durable provider on/off switch (ADR-008).…, The operator's off-switch has to mean something to the router., Turning everything off must fail loudly, not quietly route anyway., Only a human can fix these — a self-healing breaker would retry forever. (+17 more)

### Community 386 - "SetupWizardPage.js"
Cohesion: 0.13
...
### Community 387 - "test_phase4_runtime_resilience.py"
Cohesion: 0.11
...
### Community 394 - "Technical Debt Register — local-llm-server"
Cohesion: 0.08
...
### Community 395 - "_ensure_tasks_source_id_unique_index"
Cohesion: 0.11
...
### Community 396 - "CompanyAgencyService"
Cohesion: 0.12
Nodes (13): CompanyAgencyService, Any, SpecialistFamily, Orchestrates specialist activation, runtime startup, and 24x7 scheduling for a…, Return the best available runtime for a specialist family. Checks available…, Return the ordered runtime preferences for a specialist family., Activate a company's AI agency after onboarding completes. Steps: 1. Assign…, Get the current agency health status for a company. (+5 more)

### Community 397 - "Universality: case-coverage matrix"
Cohesion: 0.08
...
### Community 398 - "_harvest_changed_files"
Cohesion: 0.09
Nodes (25): A failed drive does not abandon the goal, CEO Micro-Management, Escalation, and why it terminates, Five bounds, Operator surface, Tests, The 24x7 supervisor, The anti-slop gate (+17 more)

### Community 399 - "SkillBindings"
Cohesion: 0.10
...
### Community 401 - "TestBotChallengeDetection"
Cohesion: 0.10
Nodes (14): _is_blocked_host(), _looks_like_bot_challenge(), True if the HTML is an anti-bot/CAPTCHA interstitial rather than content. Used…, Render a page with a real headless browser (Playwright/Chromium) and return…, Map a technology name to a SystemType literal using the catalog's category…, Fetch a builtwith.com page, defeating its bot protection as far as is possible…, Last-resort fallback for sites we can't fingerprint live (JS-rendered +…, Cheap (no-DNS) SSRF check for headless-browser subrequests. A rendered page's… (+6 more)

### Community 402 - "_execute_skill_impl"
Cohesion: 0.11
...
### Community 404 - "test_daily_automation_2026_08_03.py"
Cohesion: 0.11
...
### Community 406 - "test_workflow_shell_vars_are_declared.py"
Cohesion: 0.10
...
### Community 407 - "context_plan_gate.py"
Cohesion: 0.13
...
### Community 408 - "executive_advisory_api.py"
Cohesion: 0.13
Nodes (24): _company_advisory_context(), Pull a compact company profile for the C-suite advisory, or None. Best-effort:…, default_executives(), Executive, get_executive_advisory(), Return the shared :class:`ExecutiveAdvisory`, built on first use., One C-suite persona: its identity and the domain it answers from., Return the built-in C-suite personas. (+16 more)
...
### Community 410 - "PreflightReport"
Cohesion: 0.12
Nodes (16): PreflightIssue, PreflightReport, BaseModel, test_sticky_objective_memory(), check_all(), check_all(), fake_readiness(), _fake_user() (+8 more)
...
### Community 412 - "test_telegram_diag_endpoint.py"
Cohesion: 0.09
...
### Community 419 - "report_to_markdown"
Cohesion: 0.09
Nodes (12): main(), Path, Run the audit engine against ``url`` with an injected HTTP fetcher., run_local_audit(), Render the report rows as a Screaming Frog-compatible CSV string., Render an executive Markdown report., report_to_csv(), report_to_markdown() (+4 more)

### Community 420 - "test_activation_api.py"
Cohesion: 0.13
...
### Community 421 - "yaml"
Cohesion: 0.08
Nodes (10): tests/test_daily_automation_2026_09_14.py — Daily automation tests…, tests/test_daily_automation_2026_09_21.py — Daily automation tests…, Hermes must survive free-tier cold starts, and fallback must not log errors.…, A handled fallback is a warning; only an unrecoverable state is an error., TestFallbackSeverity, tests/test_openclaw_gateway.py — OpenClaw in-process WebSocket gateway tests., Dockerfile.backend does NOT install @openclaw/cli (in-process gateway now)., render_yaml() (+2 more)

### Community 422 - "test_service_token.py"
Cohesion: 0.08
...
### Community 423 - "test_commit_tracker.py"
Cohesion: 0.18
...
### Community 424 - "VoiceCommandInterface"
Cohesion: 0.15
...
### Community 427 - "Local AI Stack with Docker"
Cohesion: 0.08
...
### Community 433 - "PriorityTaskQueue"
Cohesion: 0.14
...
### Community 434 - "TemporalContextGraph"
Cohesion: 0.10
...
### Community 436 - "register_admin_gui"
Cohesion: 0.17
...
### Community 437 - "test_executive_advisory_api.py"
Cohesion: 0.14
Nodes (18): AdviceResult, The full advisory response: per-executive opinions plus the synthesis., Drop the singleton (test helper)., reset_executive_advisory(), _make_app(), FastAPI, tests/test_executive_advisory_api.py — auth and behaviour for…, Install an advisory whose LLM is a canned reply — no network. (+10 more)
...
### Community 439 - "record_step_failures"
Cohesion: 0.14
...
### Community 440 - "analyze_quantitative"
Cohesion: 0.15
...
### Community 443 - "Deploy: FreeBuff Telegram bot (24×7)"
Cohesion: 0.09
...
### Community 445 - "Implementation Prompt: Rich TaskBoard + Agile Sprint Integration"
Cohesion: 0.09
...
### Community 446 - "Telegram Bot Setup"
Cohesion: 0.09
...
### Community 450 - "implement_agent.py"
Cohesion: 0.13
...
### Community 451 - "test_north_mini_code.py"
Cohesion: 0.09
...
### Community 452 - "run_audit"
Cohesion: 0.11
Nodes (18): _build_curl_cffi_fetcher(), get(), get_text(), head(), _sess(), _build_pdf(), findings_block(), hr() (+10 more)

### Community 453 - "AgentMessageBus"
Cohesion: 0.12
...
### Community 456 - "isolated_telegram_config"
Cohesion: 0.13
...
### Community 458 - "test_cerebras_catalogue.py"
Cohesion: 0.13
...
### Community 460 - "test_mostly_failed_steps.py"
Cohesion: 0.12
...
### Community 461 - "test_repairs_when_complete_but_zero_specialists"
Cohesion: 0.09
Nodes (10): Tests for the self-onboarding bootstrap. The platform should register itself as…, When onboarding is 'complete' but 0 specialists exist, the bootstrap should…, test_disabled_returns_disabled(), test_never_raises_on_failure(), test_onboards_when_missing(), _seed(), test_repairs_when_complete_but_zero_specialists(), _fake_count() (+2 more)

### Community 462 - "ProviderManager"
Cohesion: 0.23
...
### Community 469 - "The fifteen strategies"
Cohesion: 0.09
...
### Community 470 - "TestModelRegistryUpdates"
Cohesion: 0.13
Nodes (12): Drop the cached config (test hook)., reset(), Test hook — clear all key statistics., reset(), Test hook — rebuild the registry on next access., reset(), Verify new models are in the packages/ai/registry., TestModelRegistryUpdates (+4 more)

### Community 471 - "harness_routing.py"
Cohesion: 0.14
...
### Community 473 - "WindowsServiceManager"
Cohesion: 0.19
...
### Community 474 - "_resolve_push_token"
Cohesion: 0.11
...
### Community 478 - "test_feature_matrix.py"
Cohesion: 0.12
...
### Community 480 - "get_ceo_ledger"
Cohesion: 0.14
Nodes (20): build_ceo_router(), ceo_status(), get_goal(), list_goals(), redrive_goal(), run_sweep(), Any, APIRouter (+12 more)

### Community 481 - "ClaudeCodeAdapter"
Cohesion: 0.19
...
### Community 482 - "V3 API Migration Plan — LLM Relay Platform"
Cohesion: 0.10
...
### Community 486 - "_process_task_callback"
Cohesion: 0.20
...
### Community 487 - "test_langfuse_agency_wide.py"
Cohesion: 0.10
...
### Community 491 - "_make_mock_response"
Cohesion: 0.12
...
### Community 492 - "trend_analysis.py"
Cohesion: 0.18
...
### Community 493 - "test_unit5_ui_provider_surface.py"
Cohesion: 0.10
...
### Community 496 - "test_p0_roadmap_b1_c2_a3.py"
Cohesion: 0.14
...
### Community 497 - "HarnessEnrichment"
Cohesion: 0.14
...
### Community 507 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.09
Nodes (18): Cadence & stop conditions, First-run bootstrap, Hard constraints, Master Goal Prompt — Autonomous Agency CEO, Mission, The gate contract (Telegram human-in-the-loop), Decisions (locked with the owner), Free NVIDIA brain + UI-controlled provider policy + no silent spend (+10 more)
...
### Community 509 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 514 - "test_integration_c4_c5_c6_d3.py"
Cohesion: 0.16
...
### Community 515 - "TestBrainFailoverModelUpdates"
Cohesion: 0.18
...
### Community 518 - "test_research_coordinator.py"
Cohesion: 0.11
...
### Community 519 - "test_tasks_cache_ttl_env.py"
Cohesion: 0.21
...
### Community 521 - "PerformanceAnalytics"
Cohesion: 0.12
...
### Community 522 - "Skill: fabric-patterns"
Cohesion: 0.11
...
### Community 523 - "Analysis & Synthesis Instructions"
Cohesion: 0.11
Nodes (18): 1. Define the Atmosphere, 2. Map the Color Palette, 3. Establish Typography Rules, 4. Define the Hero Section, 5. Describe Component Stylings, 6. Define Layout Principles, 7. Define Responsive Rules, 8. Encode Motion Philosophy (+10 more)

### Community 524 - "Performance Analysis — local-llm-server"
Cohesion: 0.11
...
### Community 525 - "Production Readiness Assessment — local-llm-server"
Cohesion: 0.11
...
### Community 528 - "Admin Dashboard Guide"
Cohesion: 0.11
...
### Community 529 - "ControlsScreen.jsx"
Cohesion: 0.16
...
### Community 537 - "OrchestratorCheckpointStore"
Cohesion: 0.16
...
### Community 539 - "test_brain_patch_service_token.py"
Cohesion: 0.18
...
### Community 540 - "TestSelfHealingInfrastructureClassification"
Cohesion: 0.19
...
### Community 541 - "OrchestratorSupervisor"
Cohesion: 0.16
...
### Community 544 - "SEO / GEO / AIO Audit Engine"
Cohesion: 0.12
...
### Community 547 - "TestRuntimeControl"
Cohesion: 0.15
...
### Community 551 - "Architecture Overview — local-llm-server"
Cohesion: 0.11
...
### Community 554 - "Part A — Health Report"
Cohesion: 0.11
...
### Community 555 - "test_health_endpoints.py"
Cohesion: 0.15
...
### Community 556 - "test_p0_roadmap_b3_b4_b5.py"
Cohesion: 0.16
...
### Community 559 - "test_phase5_doctor.py"
Cohesion: 0.11
...
### Community 560 - "TestStopSlopChecker"
Cohesion: 0.11
...
### Community 561 - "sys"
Cohesion: 0.01
Nodes (132): detect_secrets(), main(), Recover CHANGELOG.md from a Git merge conflict in its [Unreleased] block. Pre-…, _extract_unreleased_body(), _insert(), main(), Insert the Maintenance changelog section at the end of the [Unreleased] block.…, Return (body_start, body_end_exclusive, body) for the [Unreleased] block. (+124 more)

### Community 562 - "test_webui_provider_priority.py"
Cohesion: 0.31
...
### Community 564 - "test_contract_enforcement.py"
Cohesion: 0.17
...
### Community 565 - "ProceduralMemoryStore"
Cohesion: 0.17
...
### Community 570 - "SKILL: Industrial Brutalism & Tactical Telemetry UI"
Cohesion: 0.12
...
### Community 571 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 572 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 574 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 575 - "Section-by-Section Acceptance Criteria"
Cohesion: 0.12
...
### Community 581 - "Agent Governance Guide"
Cohesion: 0.12
Nodes (16): A tool call is judged twice, Agent Governance Guide, `[]` and absent mean opposite things, API, Approvals, Backends, Configuration, Control surfaces (+8 more)
...
### Community 584 - "_migration_block"
Cohesion: 0.15
...
### Community 585 - "test_frontend_deployment_guards.py"
Cohesion: 0.18
...
### Community 587 - "TestKillSwitchDurability"
Cohesion: 0.15
...
### Community 588 - "test_skill_registry.py"
Cohesion: 0.13
...
### Community 589 - "test_task_service_failed_comment.py"
Cohesion: 0.18
...
### Community 590 - "TestRouterIntegration"
Cohesion: 0.21
...
### Community 592 - "hermes_prompt.py"
Cohesion: 0.19
...
### Community 593 - "MemoryMiddleware"
Cohesion: 0.17
...
### Community 596 - "router/health.py"
Cohesion: 0.15
...
### Community 600 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
...
### Community 601 - "Security Analysis — local-llm-server"
Cohesion: 0.12
...
### Community 602 - "Attention Mechanisms Internals"
Cohesion: 0.12
...
### Community 604 - "Contributing to local-llm-server"
Cohesion: 0.12
...
### Community 605 - "DirectChatSession"
Cohesion: 0.13
...
### Community 606 - "TestTheCopiesMayNotDriftFurther"
Cohesion: 0.15
...
### Community 607 - "Agent Runtime Setup"
Cohesion: 0.12
...
### Community 609 - "RateLimitTracker"
Cohesion: 0.16
...
### Community 611 - "llm/router.py"
Cohesion: 0.03
Nodes (109): Fixed, collections_abc, Fixed, Modules, Writing a custom adapter, heapq, int, payload_key() (+101 more)

### Community 612 - "CollectionLike"
Cohesion: 0.20
...
### Community 614 - "test_kimi_bridge_provider.py"
Cohesion: 0.20
...
### Community 615 - "test_telegram_task_callback.py"
Cohesion: 0.17
...
### Community 620 - "DecisionsStoreTests"
Cohesion: 0.12
...
### Community 621 - "test_dockerfile_ships_root_modules.py"
Cohesion: 0.17
...
### Community 624 - "web_reach.py"
Cohesion: 0.10
Nodes (20): Ask the C-suite advisory layer a business question. This is the CEO's bridge…, _domain_matches(), _parse_domain_list(), agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Return True if *host* is *pattern* or a subdomain of it., Split a comma-separated env var into a normalised domain list., Added, Added (+12 more)

### Community 626 - "TestRoutes"
Cohesion: 0.18
...
### Community 627 - "TestBrainConfigUpdates"
Cohesion: 0.22
...
### Community 628 - "test_refresh_agent_built_proof.py"
Cohesion: 0.12
...
### Community 629 - "Autonomy Uplift — Living Roadmap & Detailed Implementation Specs"
Cohesion: 0.17
...
### Community 634 - "test_ai_insights.py"
Cohesion: 0.18
...
### Community 636 - "Skill: Agentic Portfolio Management"
Cohesion: 0.13
...
### Community 637 - "Skill: agent-harness"
Cohesion: 0.13
...
### Community 638 - "Skill: checkpoint-strategy"
Cohesion: 0.13
...
### Community 640 - "Skill: local-ai-query"
Cohesion: 0.13
...
### Community 641 - "Skill: parallel-agents"
Cohesion: 0.13
...
### Community 642 - "Skill: parallel-worktrees"
Cohesion: 0.13
...
### Community 644 - "Design System: Taste Standard"
Cohesion: 0.13
...
### Community 646 - "test_new_features_e2e.py"
Cohesion: 0.26
...
### Community 647 - "Skill: repowise-intelligence"
Cohesion: 0.13
Nodes (14): 1. Graph Intelligence (Dependency Graph), 2. Git Intelligence, 3. Documentation Intelligence, 4. Decision Intelligence, Acceptance Checks, Directory Structure, Example Usage, Implementation Approach (+6 more)

### Community 648 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 650 - "OpenClaw — iOS Control of the Agency (Single-Service Free-Tier Deploy)"
Cohesion: 0.13
...
### Community 651 - "tasks/models.py"
Cohesion: 0.07
Nodes (34): tasks — Task/issue management system. Provides a lightweight task/issue tracker…, _coerce_ts(), ExecutionLogEntry, Any, Enum, field_validator, str, tasks/models.py — Pydantic models for the task/issue system. (+26 more)

### Community 652 - "test_cost_attribution.py"
Cohesion: 0.13
...
### Community 653 - "test_rate_limiter.py"
Cohesion: 0.20
...
### Community 657 - "test_tasks_reconciler_todo_requeue.py"
Cohesion: 0.22
...
### Community 664 - "classify_direct_chat_intent"
Cohesion: 0.23
...
### Community 668 - "analyze_qualitative"
Cohesion: 0.25
...
### Community 669 - "register_user_research_tools"
Cohesion: 0.18
...
### Community 682 - "test_hermes_server.py"
Cohesion: 0.18
...
### Community 687 - "Separate hosted dashboard backend (`backend/server.py`)"
Cohesion: 0.14
...
### Community 688 - "ProvidersScreen.jsx"
Cohesion: 0.06
Nodes (24): getBrainProviders(), getLocalBrainState(), getRenderHealth(), getRenderOpsStatus(), postLocalBrainToggle(), runRenderOpsScan(), setBrainProviderEnabled(), syncProviderToRender() (+16 more)

### Community 689 - "Runbook: Auto-Resume After Cooldown / Interruption"
Cohesion: 0.14
...
### Community 691 - "TestNormalizeAnthropicOutputFormat"
Cohesion: 0.16
...
### Community 692 - "SeoIssueReportRow"
Cohesion: 0.20
...
### Community 694 - "GitHubPolicyProbe"
Cohesion: 0.19
...
### Community 703 - "PR #634 Implementation Tracker"
Cohesion: 0.20
...
### Community 704 - "test_task_self_repo_auto_commit.py"
Cohesion: 0.18
Nodes (13): coordinator(), _mock_gh(), parametrize, tests/test_task_self_repo_auto_commit.py — TaskExecutionCoordinator._build_spec…, A task with company_id set must go through the existing E2B company-repo…, SELF_REPO_AUTO_COMMIT_ENABLED=false is the rollback lever — even with valid…, If no GitHub repo/token is configured, the task must stay report-only rather…, A resolution error (e.g. agent.agency import failure) must never crash… (+5 more)

### Community 705 - "TestAdapterMetadata"
Cohesion: 0.05
Nodes (20): N2. Surface Hermes (and all runtimes) status in the Doctor/Runtimes UI ⬜  (size: S, risk: low), _env_float(), HermesAdapter, Any, AsyncClient, Read a float env var, falling back to *default* on unset/garbage., Adapter for Hermes Agent — FIRST CLASS autonomous runtime., Any (+12 more)

### Community 706 - "AgentJobSnapshot"
Cohesion: 0.28
...
### Community 707 - "agent/workspace.py"
Cohesion: 0.29
...
### Community 710 - "CollaborationContext"
Cohesion: 0.21
...
### Community 725 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 728 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
Nodes (12): Acceptance Checks, Claude's query protocol (use this instead of Read tool for exploration):, Graph Artifacts — What to Commit, How to Use the Graph (Token Savings Protocol), Installation (one-time per machine), Instead of reading raw files:, Key commands:, Relationship to repowise-intelligence Skill (+4 more)

### Community 729 - "Skill: platform-setup — Autonomous Agency Bootstrap"
Cohesion: 0.15
...
### Community 730 - "knowledge_graph.py"
Cohesion: 0.18
...
### Community 731 - "Workspace Isolation Architecture"
Cohesion: 0.15
...
### Community 733 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.15
...
### Community 735 - "ApplyReviewAgent"
Cohesion: 0.22
...
### Community 737 - "_is_bedrock_model_id"
Cohesion: 0.27
...
### Community 738 - "_get_provider_policy"
Cohesion: 0.19
...
### Community 739 - "Skill: user-research"
Cohesion: 0.15
...
### Community 740 - "._get_checkpoint_store"
Cohesion: 0.17
Nodes (6): get_orchestrator_checkpoint_store(), _NoopStore, Any, List recent runs. When ``owner_id`` is provided, only runs stamped with that…, No-op checkpoint store when the real one is unavailable., Persist run state for crash recovery.

### Community 741 - "_InMemoryBackend"
Cohesion: 0.18
...
### Community 742 - "_build_execution_request"
Cohesion: 0.27
...
### Community 743 - "TestDisabledProvidersAreNotFalselyReportedUnreachable"
Cohesion: 0.17
...
### Community 746 - "TestModelCostTableUpdates"
Cohesion: 0.26
...
### Community 748 - "test_doctor_service_token_check.py"
Cohesion: 0.23
...
### Community 749 - "test_brain_failover_413.py"
Cohesion: 0.17
...
### Community 750 - "test_dependent_tasks_are_not_concurrent"
Cohesion: 0.15
...
### Community 753 - "TestSeoApiSurface"
Cohesion: 0.18
Nodes (3): list_checks(), Return all check definitions., TestSeoApiSurface

### Community 754 - "test_task_brain_preflight.py"
Cohesion: 0.31
...
### Community 755 - "get_tracker"
Cohesion: 0.23
Nodes (10): get_tracker(), Return the shared AutonomyTracker singleton (lazy-init)., Reset the singleton (test helper)., reset_tracker(), Contract: get_tracker() returns the same instance., TestClient, tests/test_public_kpi.py — public read-only autonomy KPI endpoint. The autonomy…, The public strip must expose only aggregate counts — no user/company/repo or… (+2 more)

### Community 756 - "LLMReasoner"
Cohesion: 0.18
...
### Community 765 - "CLAUDE.md — Operating Manual"
Cohesion: 0.17
...
### Community 771 - "_register_web_reach_tools"
Cohesion: 0.22
...
### Community 774 - "skill_bindings.py"
Cohesion: 0.21
...
### Community 776 - "test_p0_roadmap_a4_a5_b2.py"
Cohesion: 0.26
...
### Community 777 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 778 - "WorkspaceMetrics"
Cohesion: 0.17
...
### Community 779 - "test_procedural_memory.py"
Cohesion: 0.22
...
### Community 780 - "TestDeprecationWarnings"
Cohesion: 0.17
...
### Community 784 - ".test_set_github_token_sqlite_string_id_does_not_500"
Cohesion: 0.20
Nodes (3): MonkeyPatch, TestClient, TestGithubTokenSQLiteRegression

### Community 785 - "TestAuthAndTaskCreation"
Cohesion: 0.17
...
### Community 789 - "Added"
Cohesion: 0.24
Nodes (9): Added, Added, buildGraphElements(), clear_stats(), get_cost_table(), Reset all aggregates (intended for testing)., Return the active cost table as a JSON-serialisable dict., _ProviderQuota (+1 more)
...
### Community 792 - "LLM Router — migration guide"
Cohesion: 0.18
...
### Community 804 - "_push_down_where"
Cohesion: 0.18
...
### Community 805 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.18
...
### Community 806 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 809 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 819 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 823 - "_normalize_tool_choice"
Cohesion: 0.31
...
### Community 825 - "TestTheSharedListFitsBothCallers"
Cohesion: 0.18
...
### Community 830 - "TestDecisionsBotLinks"
Cohesion: 0.25
...
### Community 834 - "models/seo_audit.py"
Cohesion: 0.17
Nodes (13): models/seo_audit.py - SEO / GEO / AIO Audit Contracts Typed Pydantic models for…, Lightweight listing entry for past audits., Static definition of a single audit check (catalog entry)., SeoAuditSummary, SeoCheckDefinition, list_reports(), List stored reports (most recent first), optionally filtered by company., auto_fixable_checks() (+5 more)

### Community 835 - "TestNoNvidiaFallbackIsRetired"
Cohesion: 0.22
...
### Community 839 - "financial_analyst.py"
Cohesion: 0.22
...
### Community 841 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 842 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 843 - "test_serve_spa_prefixes.py"
Cohesion: 0.27
...
### Community 844 - "Brag Plan: Autonomous AI Agency (feature tour, v2)"
Cohesion: 0.20
...
### Community 847 - "test_direct_chat_async.py"
Cohesion: 0.07
...
### Community 848 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 849 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 850 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 851 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 852 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 854 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 855 - "_start_ceo_agency"
Cohesion: 0.27
...
### Community 856 - "One command (recommended)"
Cohesion: 0.20
...
### Community 857 - ".test_recurrences_are_reported_even_inside_cooldown"
Cohesion: 0.20
Nodes (4): _noop_async(), Any, A fix that did not hold must be detectable, or it looks healed forever., latest_deploy()

### Community 858 - "What to clean up"
Cohesion: 0.20
...
### Community 863 - "_parse_reset_epoch"
Cohesion: 0.33
...
### Community 864 - "run_patched_colibri.py"
Cohesion: 0.27
...
### Community 866 - "TestPreCompiledPatterns"
Cohesion: 0.22
...
### Community 873 - "TestPoliciesGovernanceStableClaim"
Cohesion: 0.20
...
### Community 874 - "TestChatFallbackAndApproval"
Cohesion: 0.22
...
### Community 875 - "test_model_catalog_guard.py"
Cohesion: 0.29
...
### Community 879 - "test_workflow_api_mount.py"
Cohesion: 0.20
...
### Community 880 - "openclaw_reverse_proxy"
Cohesion: 0.22
...
### Community 881 - "Issue #504: EPIC: Autonomy hardening — live-verified defects 2026-06-10"
Cohesion: 0.25
...
### Community 882 - "Fixed"
Cohesion: 0.33
Nodes (7): Convenience: the canonical text response, whether success or failure., Fixed, Fixed, MonkeyPatch, Path, test_new_scaffolds_pattern(), test_save_and_show_roundtrip()

### Community 884 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 886 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 887 - "test_seo_fetch.py"
Cohesion: 0.28
...
### Community 889 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 896 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 897 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 900 - "test_probe_base_url_override_hits_the_typed_url"
Cohesion: 0.22
...
### Community 901 - "LLM Router — provider guide"
Cohesion: 0.22
...
### Community 904 - "ENGINEERING_STANDARDS.md — Patterns & Reference"
Cohesion: 0.22
...
### Community 905 - "GovernanceScreen.jsx"
Cohesion: 0.25
Nodes (5): AuditTable(), BACKEND_META, DECISION_COLOR, relTime(), GovernanceScreen

### Community 906 - "TestPaidPolicyDurability"
Cohesion: 0.22
...
### Community 913 - "test_changelog_parity_guard.py"
Cohesion: 0.22
...
### Community 919 - "TestEveryFullSuiteJobHasMongo"
Cohesion: 0.22
...
### Community 920 - "fastapi_testclient"
Cohesion: 0.08
Nodes (25): fastapi_testclient, client(), Tests for Company Graph API endpoints., Create a test client for the FastAPI app., Test Company Graph API endpoints., Test that the company API router is included., Test Doctor endpoint., Test the public doctor endpoint. (+17 more)

### Community 921 - "memory_consolidation.py"
Cohesion: 0.36
...
### Community 929 - "hybrid_reasoning.py"
Cohesion: 0.36
...
### Community 930 - "get_harness_adapter"
Cohesion: 0.11
Nodes (13): get_harness_adapter(), harness_active(), harness_catalog(), #522 + #505: Reliability startup — schedule hydration, orchestrator restore,…, Return the full ECC harness catalog with capabilities. Public — no auth…, Return the currently active ECC harnesses with session metrics. Authenticated —…, _startup_reliability_hooks(), get_harness_registry() (+5 more)

### Community 931 - "quality_checker.py"
Cohesion: 0.32
...
### Community 932 - "research_coordinator.py"
Cohesion: 0.36
...
### Community 939 - "Skill: memory-consolidation (Dream Memory)"
Cohesion: 0.25
...
### Community 975 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 983 - "TestAgentAutoAssignment"
Cohesion: 0.25
...
### Community 984 - "test_local_brain_router_smoke.py"
Cohesion: 0.25
...
### Community 989 - "test_provider_models_db_outage.py"
Cohesion: 0.25
...
### Community 990 - "test_seo_audit_pending_expiry.py"
Cohesion: 0.43
...
### Community 991 - ".discover_directory"
Cohesion: 0.29
...
### Community 995 - "_start_in_web_bot_tasks"
Cohesion: 0.29
...
### Community 996 - "CLAUDE.md — router/"
Cohesion: 0.29
...
### Community 1002 - "build_connectors_router"
Cohesion: 0.38
...
### Community 1015 - "Platform Controls"
Cohesion: 0.29
...
### Community 1016 - "Cloudflare = the real working app"
Cohesion: 0.29
...
### Community 1017 - "Workspace Issues"
Cohesion: 0.29
...
### Community 1021 - "Agent Transparency Report"
Cohesion: 0.29
...
### Community 1023 - "test_log_monitor_storm_guard.py"
Cohesion: 0.48
...
### Community 1032 - "check_doc_images.py"
Cohesion: 0.48
...
### Community 1036 - "TestReasonsAreActionable"
Cohesion: 0.29
...
### Community 1037 - "TestProvidersScreen"
Cohesion: 0.43
...
### Community 1040 - "openclaw_mobile_ui"
Cohesion: 0.33
...
### Community 1048 - "._extract_tokens"
Cohesion: 0.40
...
### Community 1052 - "Music Cues: happy-beats-business-moves-vol-1-by-ende-dot-app"
Cohesion: 0.33
...
### Community 1053 - "/fix-bug — Bug Fix Agent"
Cohesion: 0.33
...
### Community 1055 - "pre-commit"
Cohesion: 0.60
Nodes (5): pre-commit script, _error(), _head(), _info(), _warn()

### Community 1056 - "Skill: browserbase-fetch — Lightweight Web Fetch"
Cohesion: 0.33
...
Cohesion: 0.33
Nodes (6): 2026-06-25, 2026-06-26, 2026-07-04, 2026-07-05, 2026-07-09, What's New

### Community 1067 - "The full agent capability roster"
Cohesion: 0.33
...
### Community 1068 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 1070 - "Runtime & Onboarding Issues"
Cohesion: 0.33
...
### Community 1073 - "gen_v4_screenshots.py"
Cohesion: 0.60
...
### Community 1097 - "_known_entry_texts"
Cohesion: 0.40
...
### Community 1100 - "WorkspaceEscapeError"
Cohesion: 0.40
...
### Community 1101 - ".daily_active_users"
Cohesion: 0.40
...
### Community 1103 - "feature-implementer.md"
Cohesion: 0.40
...
### Community 1124 - "test_rate_limiter_concurrency.py"
Cohesion: 0.60
Nodes (4): check_rate_limit(), asyncio, test_rate_limiter_concurrency(), call_limit()

### Community 1125 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1126 - "4. Agent Execution Performance"
Cohesion: 0.50
...
### Community 1138 - "TestHermesKeepAlive"
Cohesion: 0.40
...
### Community 1142 - "TestGhIsNotReAuthenticated"
Cohesion: 0.40
...
### Community 1144 - "_clean_director"
Cohesion: 0.50
...
### Community 1159 - "stop_colibri_server.ps1"
Cohesion: 0.83
Nodes (3): Fail(), Ok(), W()

### Community 1160 - "submit_simple_task"
Cohesion: 0.50
Nodes (4): Submit a task to the agent planner., Submit a simple task via the tasks API., submit_simple_task(), submit_task()

### Community 1161 - "_is_brain_connection_error"
Cohesion: 0.50
...
- **3067 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3062 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 13979 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **179 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `AgentRunner` connect `AgentRunner` to `os`, `backend/server.py`, `Added`, `pytest`, `AgentJobRequest`, `failover_client.py`, `ContextPruner`, `Agency Core — Progress & Resume Log`, `RuntimeAdapter`, `proxy.py`, `AgentPlan`, `Universality: case-coverage matrix`, `InternalAgentAdapter`, `test_agent_chat_integration.py`, `TestDeprecationWarnings`, `Changed`, `GitHubTools`, `Added`, `Added`, `failover_chat_completion`, `test_autonomous_agency_e2e.py`, `TestAgentLoopMCPIntegration`, `state.py`, `PolicyEngine`, `test_agency.py`, `test_direct_chat_evolution.py`, `TaskSpec`, `workflow_orchestrator.py`, `build_governance_router`, `test_agent_runner.py`, `MCPUnavailableError`, `MultiAgentSwarm`, `LocalWorkspace`, `ContextManager`, `FreeBuffAgent`, `test_governance_api.py`, `Section-by-Section Acceptance Criteria`, `Issue #656: Bugs`, `resolve_active_brain`, `Fixed`, `AdaptiveHalter`, `test_verification_strategies.py`, `CEODispatcher`, `WorkspaceTools`, `_resolve_push_token`, `.apply_diff`, `StuckDetector`, `UserMemoryStore`, `_runner`, `ReactScratchpad`, `TokenBudget`, `test_repo_connection.py`, `test_brain_failover_413.py`, `Issue #504: EPIC: Autonomy hardening — live-verified defects 2026-06-10`, `Fixed`, `[Unreleased]`, `AgentSessionStore`, `test_daily_2026_06_04.py`, `Killer TODO Roadmap — local-llm-server`, `.execute`, `WorkflowOrchestrator`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `ma()` connect `failover_client.py` to `de`, `test_agency.py`, `la`, `gsap.min.js`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `StopSlopChecker` connect `StopSlopChecker` to `quality_checker.py`, `TestStopSlopChecker`, `AITellIssue`, `.test_cleans_removes_double_spaces`, `.test_detects_multiple_throat_clearing`, `.test_detects_wh_starters`, `.test_cleans_emphasis_crutches`?**
...
- **Should `os` be split into smaller, more focused modules?**
  _Cohesion score 0.013052867920579197 - nodes in this community are weakly interconnected._
- **Should `backend/server.py` be split into smaller, more focused modules?**
  _Cohesion score 0.012367025656226329 - nodes in this community are weakly interconnected._
- **Should `secrets_store.py` be split into smaller, more focused modules?**
  _Cohesion score 0.021020156314273963 - nodes in this community are weakly interconnected._