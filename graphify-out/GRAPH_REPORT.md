...
### Community 43 - "CompanyGraphStore"
Cohesion: 0.03
...
### Community 60 - "_start_autonomy_loops"
Cohesion: 0.05
...
### Community 94 - "test_agent_runner.py"
Cohesion: 0.05
...
### Community 116 - "test_agent_tool_governance.py"
Cohesion: 0.06
...
### Community 130 - "SpecialistService"
Cohesion: 0.05
...
### Community 173 - "test_unit6_resolve_component_model.py"
Cohesion: 0.05
...
### Community 194 - "models/seo_audit.py"
Cohesion: 0.09
...
### Community 276 - "agents/agile_ceremonies.py"
Cohesion: 0.08
...
### Community 316 - "CompanyAgencyService"
Cohesion: 0.09
...
### Community 323 - "RuntimeDependency"
Cohesion: 0.11
...
### Community 326 - "get_tool_registry"
Cohesion: 0.09
...
### Community 359 - "TestNoNvidiaFallbackIsRetired"
Cohesion: 0.09
...
### Community 371 - "telegram_inbound_handlers.py"
Cohesion: 0.13
...
### Community 385 - "SeoCheckDefinition"
Cohesion: 0.10
...
### Community 395 - "sam_livekit_worker.py"
Cohesion: 0.13
...
### Community 434 - "_redact_for_notification"
Cohesion: 0.10
...
### Community 454 - "test_telegram_task_callback.py"
Cohesion: 0.12
...
### Community 510 - "resolve_free_nvidia_brain"
Cohesion: 0.12
...
### Community 519 - "test_compare_runtimes.py"
Cohesion: 0.12
...
### Community 546 - "test_llm_router_tpm.py"
Cohesion: 0.17
...
### Community 560 - "_check_storage_health"
Cohesion: 0.12
...
### Community 612 - "DailyDigestAggregatorTests"
Cohesion: 0.19
...
### Community 617 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 647 - "test_scanner_live.py"
Cohesion: 0.23
...
### Community 665 - "DirectChatSession"
Cohesion: 0.15
...
### Community 790 - "_extract_pytest_failure"
Cohesion: 0.31
...
### Community 797 - "test_event_log.py"
Cohesion: 0.45
...
### Community 823 - "TestModelsEndpointAliases"
Cohesion: 0.31
...
### Community 866 - "_governance_identity"
Cohesion: 0.22
...
### Community 873 - "TestGithubSignalHardening"
Cohesion: 0.22
...
### Community 874 - "TestPaidPolicyDurability"
Cohesion: 0.22
...
### Community 888 - "_build_direct_chat_schedule_suggestion"
Cohesion: 0.32
...
### Community 889 - "_parse_tool_calls_from_response"
Cohesion: 0.39
...
### Community 953 - "TestPoliciesGovernanceStableClaim"
Cohesion: 0.25
...
### Community 961 - "test_runtimes_health_endpoint.py"
Cohesion: 0.25
...
### Community 963 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.25
...
### Community 1011 - "TestGetCurrentTimeTool"
Cohesion: 0.43
...
### Community 1020 - "InitiativeProgress"
Cohesion: 0.33
...
### Community 1021 - "openclaw_mobile_ui"
Cohesion: 0.33
...
### Community 1058 - "TestDirectChatAgentExecution"
Cohesion: 0.33
...
### Community 1062 - "_normalize_dockerfile"
Cohesion: 0.33
...
### Community 1084 - "Admin Dashboard Issues"
Cohesion: 0.40
...
### Community 1085 - "Agent API Issues"
Cohesion: 0.40
...
### Community 1086 - "Network and Tunnel Issues"
Cohesion: 0.40
...
### Community 1111 - "TestTelegramNotifications"
Cohesion: 0.40
...
### Community 1154 - "JWTUserStateMiddleware"
Cohesion: 0.67
...
- **Why does `_fixture()` connect `_fixture` to `test_brain_patch_service_token.py`, `llm/router.py`, `test_llm_router_queue_cache.py`, `E2BSandboxSession`, `AgentJobManager`, `test_gh_brain_failover.py`, `test_llm_router_strategies.py`, `TestWorkspace`, `ImprovementLoop`, `test_model_router.py`, `test_operational_incidents.py`, `BrainConfig`, `TaskStore`, `Task`, `SelfHealingAgent`, `TrafficDirector`, `services/seo_audit.py`, `PolicyEngine`, `WorkflowRun`, `test_llm_router_resilience.py`, `AgentSessionStore`, `test_company_api.py`, `test_llm_router_tpm.py`, `BrainWatchdog`, `test_telegram_service_webhook.py`, `test_failover_client_shared.py`, `test_telegram_webhook.py`, `PrimeAgentAdapter`, `Agency`, `OnboardingService`, `test_unit8_model_catalog.py`, `UserRole`, `KeyPool`, `AgentSwarm`, `_start_autonomy_loops`, `enforcement.py`, `TaskStatus`, `AgentDefinition`, `ChatHistoryStore`, `test_openclaw_endpoints.py`, `FreeBuffAgent`, `TokenBudget`, `ResearchTask`, `ExecutionRequest`, `clear_cooldowns`, `validate_policy_text`, `test_provider_router.py`, `resolve_e2b_config`, `config.py`, `brain_failover.py`, `_resolve_brain_provider`, `TestClient`, `test_ai_insights.py`, `SQLiteStore`, `test_procedural_memory.py`, `claim`, `_resolve_push_token`, `e2e/test_browser.py`, `test_startup_warmup.py`, `test_autonomy_status.py`, `test_brain_failover_413.py`, `OutputFilter`, `test_colibri_brain_shim.py`, `test_local_brain_state.py`, `WorkspaceTools`, `test_refresh_agent_built_proof.py`, `test_tasks_reconciler_todo_requeue.py`, `test_self_heal_v2.py`, `test_knowledge_sync.py`, `get_scheduler`, `run_task`, `test_agent_tool_governance.py`, `FeatureMaturity`, `ModelRouter`, `test_context_rulebook.py`, `ArtifactStore`, `test_response_cache.py`, `TaskPriority`, `KeyStore`, `test_new_features_e2e.py`, `test_kimi_bridge_server.py`, `_step`, `BackgroundAgent`, `resolve_active_brain`, `test_telegram_freebuff.py`, `test_trend_watcher.py`, `TestHarnessAdapter`, `test_changelog_check_workflow.py`, `test_openclaw_gateway.py`, `persist_plan_spec`, `TestEstimateTokensForMessages`, `test_daily_2026_07_27.py`, `test_ceo_router.py`, `tests/conftest.py`, `E2BAdapter`, `test_process_quick_note_workflow.py`, `OllamaCircuitBreaker`, `_job_text`, `_Budget`, `models/seo_audit.py`, `test_features_api.py`, `TestAgentRunnerSafety`, `test_video_transcript.py`, `TrendWatcher`, `test_provider_state_durability.py`, `NotificationDispatcher`, `WorkflowBuildRequest`, `WorkflowRun`, `test_sam_livekit.py`, `SchedulerStore`, `test_portfolio_intake.py`, `test_agile_api.py`, `test_app_settings.py`, `TestClient`, `test_task_clarification.py`, `ContextPruner`, `test_brain_availability_doctor.py`, `test_persistent_memory.py`, `SecurityScanner`, `test_llm_router_e2e.py`, `model_discovery.py`, `test_platform_controls.py`, `test_mcp_governance.py`, `test_sam_voice.py`, `OrchestratorQueue`, `test_nvidia_model_discovery.py`, `rate_limiter.py`, `test_catalogue_probe.py`, `session_retro.py`, `test_purge_backlog.py`, `TestMongoGate`, `RuntimeDependency`, `analyze_page`, `_resolve_user_github_token`, `test_scheduler_hydration_bounded.py`, `test_regression.py`, `test_agent_scripts_share_one_model_list.py`, `test_crispy_burn_in.py`, `test_provider_enable_disable.py`, `test_skill_registry_boot_refresh.py`, `TestSwarmRoleRouting`, `isolated_telegram_config`, `test_phase5_doctor.py`, `telegram_inbound_handlers.py`, `test_webui_provider_priority.py`, `_undeclared`, `SeoCheckDefinition`, `test_service_token.py`, `test_harness_spec.py`, `test_agent_free_brain.py`, `test_agency_fix.py`, `_Recorder`, `test_dashboard_cache.py`, `OrchestratorCheckpointStore`, `test_monitor_lib.py`, `TestTheWorkflowIsSafeAndReadOnly`, `test_v4_api.py`, `test_ping.py`, `test_runtimes_health_endpoint.py`, `test_task_store_fails_loud_in_production.py`, `test_telegram_task_callback.py`, `test_telegram_diag_endpoint.py`, `test_langfuse_agency_wide.py`, `test_voice_pipeline.py`, `client`, `clear_override`, `cost_tracker.py`, `TestNormalizeResponseFormat`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `TaskSpec`, `proxy.py`, `test_governance_api.py`, `E2BSandboxSession`, `AgentJobManager`, `TestWorkspace`, `AdaptiveHalter`, `test_agent_free_brain.py`, `ReactScratchpad`, `PolicyEngine`, `BackgroundAgent`, `WorkflowRun`, `ContextManager`, `test_empirical_verify.py`, `AgentSessionStore`, `TestAgentRunnerExecution`, `loop.py`, `test_failover_client_shared.py`, `MultiAgentSwarm`, `Agency`, `StuckDetector`, `direct_chat.py`, `E2BAdapter`, `TestAgentLoopMCPIntegration`, `enforcement.py`, `test_daily_automation_2026_07_11.py`, `FreeBuffAgent`, `TokenBudget`, `CEODispatcher`, `TestAgentRunnerSafety`, `LocalWorkspace`, `test_agent_chat_integration.py`, `_resolve_push_token`, `test_agent_runner.py`, `test_brain_failover_413.py`, `WorkspaceTools`, `test_backend_server_features.py`, `InternalAgentAdapter`, `TestGetCurrentTimeTool`, `test_agent_tool_governance.py`, `GitHubTools`, `UserMemoryStore`, `ContextPruner`, `workflow_orchestrator.py`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderRouter` to `backend/server.py`, `test_implement_agent_routing.py`, `test_all_providers_discovery.py`, `implement_agent.py`, `ProviderConfig`, `TrafficDirector`, `test_bedrock_live.py`, `test_chat_mode_regressions.py`, `failover_client.py`, `kimi_bridge_provider_config`, `direct_chat.py`, `TestLegacyRouterCacheTTL`, `test_anthropic_refusal_fallback.py`, `clear_cooldowns`, `TestRouterIntegration`, `test_provider_router.py`, `TestLegacyRouterServerFallback`, `_payload`, `TestOpenAiToBedrockConverse`, `test_colibri_brain_shim.py`, `ChatResponse`, `TestAnthropicPayloadStructuredOutput`, `ai/router.py`?**
